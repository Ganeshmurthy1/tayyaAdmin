			...
			<div class="row">
				...
				<s:if test="%{#session.Company!=null && #session.User!=null}">
					...
					<input type="hidden"
						...
						id="user_id">
					<form action="companyTrainReports" method="post" id="filterform">
											...
											<div class="row">
												...
												<div class="col-sm-4">
													<div class="form-group clearfix">
														...
														<div class="col-sm-6">
															<input type="text" autocomplete="on" class="form-control"
																id="Locationfrm" placeholder="from location"
																name="commonReportPage.flightReportFilter.fromLocation"        
																>
														</div>
														...
														<div class="col-sm-6">
															<input type="text" class="form-control" id="LocationTo"
																...
																name="commonReportPage.flightReportFilter.toLocation"
																>
