							...
							<div class="col-sm-3 clearfix pull-right">
								<div class="add-new">
									<a class="btn btn-primary but btn-clean" style="border: 2px solid #a1a1a1;border-radius: 15px" role="button"
										href="adduserband"> <i class="fa fa-plus "> Add New </i>
									</a>
								</div>
							</div>
						</div>
								...
								<tr>
									...
									<td>
										<p data-placement="top" title="edit">
											...
											<a
												href="EditBand?employeeBandModel.bandId=<s:property value="bandId"/>" style="border: 1px solid #a1a1a1;border-radius: 3px;" role="button"
