...
public class TrainWeeklyAndMonthlyDao {

	public static final Logger logger = Logger.getLogger(TrainWeeklyAndMonthlyDao.class);
	
	public Map<String, Integer> getTrainWeeklyOrMonthlyReport(User userSessionObj, Company companySessionObj, List<String> userIdList,String reportType) {
		List<TrainOrderRow> trainOrderRows=new ArrayList<>();
		...
		try {
			...
			if (userSessionObj != null && companySessionObj != null) {
				...
				trainOrderRows = criteria.list();
				for (TrainOrderRow trainOrderRow : trainOrderRows) {
					String[] datenTime =trainOrderRow.getCreatedAt().toString().split(" ");
	...
	public Long getTrainWeeklyOrMonthlyCancellationCount(User userSessionObj, Company companySessionObj, List<String> userIdList,String reportType) {
		List<TrainOrderRow> trainOrderRows=new ArrayList<>();
		Map<String, Integer> weekMap=new HashMap<>();
		SessionFactory sessionfactory;
		Session session = null;
