...
@Entity
@Table(name = "car_credit_note")
public class CarCreditNote implements Serializable{
	...
	public Long getCarOrderRowId() {
		return carOrderRowId;
	}
	public void setCarOrderRowId(Long carOrderRowId) {
