			...
			<div class="form-group" id="user_form-group" >
							...
							<div class="col-sm-3 clearfix pull-right">
								<div class="add-new">
									<a class="btn btn-primary but btn-clean" style="border: 2px solid #a1a1a1;border-radius: 15px" role="button"
										href="employeeDesignationsPage"> <i class="fa fa-plus "> Add New </i>
									</a>
								</div>
							</div>
						</div>
				...
				<div class="table-responsive dash-table">
					<table  id="mytable" class="table table-striped"
						...
						<tbody>
							<s:iterator value="employeeDesignationModelList" status="rowCount">
								<tr>
									 <td><s:property
											value="%{((commonConfigPage.currentPageIndex - 1)*commonConfigPage.maxItems)+#rowCount.count}" /></td>	
									<td><s:property value="bandId" /></td>
									<td><s:property value="userName"/></td>
									<td><s:property value="bandName" /></td>
									<td><s:property value="designation" /></td>
									<td>
										<p data-placement="top" title="edit">

											<a
												href="EditEmployeeDesignation?employeeDesignationModel.id=<s:property value="id"/>" style="border: 1px solid #a1a1a1;border-radius: 3px;" role="button"
