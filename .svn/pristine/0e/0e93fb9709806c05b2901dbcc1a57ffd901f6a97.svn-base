  ...
  function  updateKnockOff(rowId){
  	  ...
  	  $('#'+rowId+'loader').show();
  		 $.ajax({
				    method: "POST",
				    url:finalUrl,
				    data: {travelType:'I',rowId:rowId,totInvoiceAmount:totInvoiceAmount,receiveAmount:receivedAmount},
...
<body>
	<div class="content-wrapper">
		...
		<section class="content-header">
			<h1>Insurance KnockOff Reports</h1>
						...
						<div class="table-responsive dash-table">
							...
							<div class="box clearfix">
								<table id="example" class="table table-striped table-bordered">
									...
									<tbody>
										 <s:if test="knockOffPage.insuranceRows !=null && knockOffPage.insuranceRows.size()>0">
									 <s:iterator value="knockOffPage.insuranceRows" status="rowCount">
											<tr>
