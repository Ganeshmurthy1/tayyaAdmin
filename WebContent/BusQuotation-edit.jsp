				...
				<div class="row">
					...
					<div class="col-sm-12"> 
						<div class="panel-group" id="accordion"> 
										<form action="updateBusQuotation" method="post"
					...
					<div class="inner-compreg clearfix">
												...
												<div class="col-sm-2">
													<div class="form-group">
														<label for="busTravelRequest.firstName"
															class=" control-label">pick up</label> <input
															type="text" autocomplete="off"
															name=busTravelRequestQuotation.pickUp
															class="form-control input-sm" id="firstName" 
															value='<s:property value="busTravelRequestQuotationlist[0].pickUp"/>'
															required placeholder="Enter pickUp ">
													</div>
												</div>
												<div class="col-sm-2">
													<div class="form-group">
														<label for="busTravelRequest.lastName"
															class=" control-label">drop off </label> <input
															type="text" autocomplete="off"
															name=busTravelRequestQuotation.dropOff
															class="form-control input-sm" id="lastName" 
															value='<s:property value="busTravelRequestQuotationlist[0].dropOff"/>'
															required placeholder="Enter drop off">
													</div>
												</div>
												...
												<div class="col-sm-2">
													<div class="form-group">
														<label for="busTravelRequestQuotation.currency">Currency
														</label> <select class="form-control input-sm"
															name="busTravelRequestQuotation.currency" id="Currency"
															>
												...
												<div class="col-sm-2">
													<div class="form-group">
														<label for="busTravelRequestQuotation.totalAmount"
															...
															class="form-control input-sm" id="totalAmount" 
															value='<s:property value="busTravelRequestQuotationlist[0].totalAmount"/>'
					...
					<div class="form-group text-center">
													<div class="col-xs-12 submitWrap text-center">
														<input type="hidden" name="busTravelRequestQuotation.id" id="tripId"
															value="${busTravelRequestQuotationlist[0].id}">
														<button type="button" 
