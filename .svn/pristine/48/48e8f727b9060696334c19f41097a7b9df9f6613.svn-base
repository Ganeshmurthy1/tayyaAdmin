		...
		<div class="col-sm-8 clearfix " data-placement="top">	
			...
			<section class="content">
				...
				<div class="row">
					...
					<div class="col-sm-12">
						<form action="updateInsuranceTravelRequest" method="post"
					...
					<div class="inner-compreg clearfix">
											...
											<div class="col-sm-2">				
													...
													<div class="form-group">
														<label for="carTravelRequest.TRNo" class=" control-label">
															...
															autocomplete="off" name=insuranceTravelRequest.TRNo
															class="form-control input-sm" id="TRNo" value='<s:property value="insuranceTravelRequest.TRNo"/>' required
															placeholder="Enter Travel Request Number">
													</div>
												 </div>
												 	<div class="col-sm-2">
													<div class="form-group">
														<label for="insuranceTravelRequest.noOfTravelers" class=" control-label">
															no of Travelers </label> <input type="text"
															autocomplete="off" name=insuranceTravelRequest.noOfTravelers
															class="form-control input-sm cusValidationforprice" id="TRNo"  min="1" value='<s:property value="insuranceTravelRequest.noOfTravelers"/>' required
															placeholder="Enter Travel Request Number ">
													</div>
												 </div>
												 	<div class="col-sm-2"> 
													...
													<div class="form-group">
														...
														<input type="text" autocomplete="off"
															name="insuranceTravelRequest.firstName" value='<s:property value="insuranceTravelRequest.firstName"/>'
															class="form-control input-sm" required="required"
													...
													<div class="form-group">
														<label for="carTravelRequest.lastName">LastName </label> <input
															type="text" autocomplete="off" value='<s:property value="insuranceTravelRequest.lastName"/>'
											...
											<div class="form-group text-center">
												...
												<input type="hidden" name="insuranceTravelRequest.id" id="tripId" value="${insuranceTravelRequest.id}">
