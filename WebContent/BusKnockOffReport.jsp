	  ...
	  var receivedAmount=$('#'+rowId+'receivedAmount').val();
  	  ...
  	  $('#'+rowId+'loader').show();
  		 $.ajax({
				    method: "POST",
				    url:finalUrl,
				    data: {travelType:'B',rowId:rowId,totInvoiceAmount:totInvoiceAmount,receiveAmount:receivedAmount},
						...
						<div class="table-responsive dash-table">
							...
							<div class="box clearfix">
								<table id="example" class="table table-striped table-bordered">
									...
									<tbody>
										 <s:if test="knockOffPage.busRows !=null && knockOffPage.busRows.size()>0">
									 <s:iterator value="knockOffPage.busRows" status="rowCount">
											<tr>
