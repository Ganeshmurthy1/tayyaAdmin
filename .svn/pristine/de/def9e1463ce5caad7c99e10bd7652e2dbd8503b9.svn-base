	...
	<div class="content-wrapper">
		...
		<section class="content">
			...
			<div class="row">
				...
				<form action="companyMiscellaneousReports" method="post" id="filterform">
				<input type="hidden"
					value="<s:property value="%{#session.Company.company_userid}"/>"
					id="companyUserId"> <input type="hidden"
					value="<s:property value="%{#session.Company.Email}"/>" id="email">
								...
								<table id="example" class="table table-striped table-bordered" style=" white-space:nowrap;">
									<thead>
										...
										<th>S.No</th>
											...
											<th>Booking Date</th>
											<!-- <th>Travel Date</th> -->
											<s:if test="%{#session.Company.companyRole.isCorporate()==false || #session.User.userrole_id.isSuperuser() }">
