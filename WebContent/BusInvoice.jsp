 ...
 <div class="content-wrapper">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
     ...
     <div class="row">
     <div class="col-sm-12"> 
     <input type="hidden" id="busid" value="<s:property value="busOrderRow.orderId"/>">
      <div class="col-sm-6"> 
  ...
  <textarea class="form-control" rows="2" id="invoiceFromEmails"></textarea>
      ...
      <div class="modal-footer">
       <button type="button"   onclick="sendBusOfflineVoucherOrInvoiceToMail('invoice','<s:property value="busOrderRow.orderId"/>');" class="btn btn-primary btn-sm">SEND INVOICE</button>
...
<!-- Main content -->
  <section class="content">
          	...
          	<div class="col-sm-6">  
          		...
          		<a href='<s:text name="global.resourceApiUrl"></s:text>getpdf/invoice?orderid=<s:property value="busOrderRow.orderId"/>&travelcode=3' class="btn btn-success btn-xs"   >
															Pdf </a> 
          	</div>
          	<div class="col-sm-6">
						<h4 >
...
<!-- Main row -->
	...
	function calldataplugin()
	{
		...
		var orderid = $("#busid").val();		
		 var formURL = ApiURL+"Email/getHtmlTemplateById?orderid="+orderid+"&emailType=65"; 
	 	//var formURL = "http://localhost:8090/LintasTravelAPI/Email/getHtmlTemplateById?orderid="+orderid+"&emailType=65";
		
		//console.log("getting plugin data content----------"+formURL);
		$.ajax({
			url : formURL,
			type : "GET",
			dataType : "html",
      ...
      <script type="text/javascript">
       ...
       function sendBusOfflineVoucherOrInvoiceToMail(type,orderId) {
        	var toEmails= null;
        	var ccEmails= null;
        	if(type=='voucher'){
          ...
          $.ajax({	
	                url: 'sendBusOfflineVoucherOrInvoiceToMail',
	                type: 'post',
