 ...
 <div class="content-wrapper">
						...
						<div class="row">
							...
							<div class="col-sm-8 clearfix " data-placement="top">
								<a href="goTrips" class="btn btn-top-link btn-xs"> All
									Trips </a> <a href="FlightTravelRequestList"
									...
									Bus Trips </a> <a href="VisaTravelRequestList"
									class="btn btn-top-link btn-xs"> Visa Trips </a> <a
									href="InsuranceTravelRequestList"
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
     ...
     <div class="row">
     <div class="col-sm-12"> 
    <input type="hidden" id="trainid" value="<s:property value="trainOrderRow.orderId"/>">
      <div class="col-sm-6"> 
  ...
  <textarea class="form-control" rows="2" id="invoiceFromEmails"></textarea>
      ...
      <div class="modal-footer">
       <button type="button"   onclick="sendTrainOfflineVoucherOrInvoiceToMail('invoice','<s:property value="trainOrderRow.orderId"/>');" class="btn btn-primary btn-sm">SEND INVOICE</button>
...
<!-- Main content -->
  <section class="content">
          	...
          	<div class="col-sm-6">  
          		...
          		<a href='<s:text name="global.resourceApiUrl"></s:text>getpdf/invoice?orderid=<s:property value="trainOrderRow.orderId"/>&travelcode=5' class="btn btn-success btn-xs"   >
															Pdf </a> 
          	</div>
          	<div class="col-sm-6">
						<h4 >
...
<!-- Main row -->
	...
	function calldataplugin()
	{
		...
		var orderid = $("#trainid").val();		
		var formURL = ApiURL+"Email/getHtmlTemplateById?orderid="+orderid+"&emailType=67";		
		//var formURL = "http://localhost:8090/LintasTravelAPI/Email/getHtmlTemplateById?orderid="+orderid+"&emailType=67";
      ...
      <script type="text/javascript">
       ...
       function sendTrainOfflineVoucherOrInvoiceToMail(type,orderId) {
        	var toEmails= null;
        	var ccEmails= null;
        	if(type=='voucher'){
          ...
          $.ajax({	
	                url: 'sendTrainOfflineVoucherOrInvoiceToMail',
	                type: 'post',
