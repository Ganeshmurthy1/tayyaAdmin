		...
		<section class="content">
			...
			<div class="row">
				...
				<input type="hidden"
					...
					id="user_id">
				<form action="companyInsuranceOrders" method="post" id="filterform">
										...
										<s:iterator value="commonReportPage.items" status="rowCount">
											<tr>
												...
												<%-- <td><s:property value="firstName" /> <s:property
														value="lastName" /></td> --%>
												<%-- <td width="100%"><s:property value="confirmationNumber" /></td> --%>
												
												<%-- <td><s:date name="insuranceBookingDate" format="dd/MMM/yyyy" /></td> --%>
												<%-- 
												...
												<p data-placement="top">
													 <a
															href="showPassengerOrderDetails?id=<s:property value="insuredProductOrderRowId"/>&orderId=<s:property value="insuredProductRowOrderId"/>&companyId=<s:property value="insuredProductRowCompanyId"/>"
															class="btn btn-success btn-xs" data-toggle="modal">
															Edit </a>
															</p>
															</td>
