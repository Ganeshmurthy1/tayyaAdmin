...
@Entity
@Table(name = "train_credit_note")
public class TrainCreditNote implements Serializable{
	...
	public Long getTrainOrderRowId() {
		return trainOrderRowId;
	}
	public void setTrainOrderRowId(Long trainOrderRowId) {
