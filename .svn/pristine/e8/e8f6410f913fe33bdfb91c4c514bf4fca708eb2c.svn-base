		...
		<div class="col-sm-12">
			<div class="form-group" id="user_form-group" >
				...
				<input type="hidden"
					...
					id="user_id">
						...
						<div class="row">
							...
							<div class="col-xs-4 clearfix pull-right">
					<div class="add-new">
 			...
 			<table id="mytable" class="table table-striped"
					...
					<!-- class="shorten-text"	 --><td ><s:property value="Companyname" /></td>
								...
								<td>
									<form action="setSuperUserCompanyLock" method="post">
										<input type="hidden" name="companyid"
										...
										<input type="hidden" name="Status"
											...
											value="<s:property value="Locked"/>" id="Locked">
											 ...
											 <input	type="submit"	value="UnLock" id="stat<s:property value="id"/>"> <!-- value="UnLock" -->
											 </div>
                                              </s:if>
                                              <s:if test="Locked == false">
                                              <div  class="locked" >
                                              <i class="fa fa-unlock"></i>
                                               <input type="submit" value=" Lock" id="stat<s:property value="id" />"></div><!-- value="Lock" -->
                                              </s:if>
 										</form>
								</td> 
								...
								<td>
									...
									<div class="dropdown">
									    <button class="btn btn-primary btn-xs dropdown-toggle" id="menu1" type="button" data-toggle="dropdown"><i class="fa fa-cog" aria-hidden="true"></i>
									    <span class="caret"></span></button>
									    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1"> 
									      <li role="presentation"><a href="companyDetails?pageId=7&statusCode=0&actionId=23&detailType=5&companyid=<s:property value="companyid"/>"
											 > View  </a>  </li> 
									      <li role="presentation"> <a href="superUserCompanyUpdate?pageId=7&statusCode=0&actionId=24&detailType=6&companyid=<s:property value="companyid"/>&Email=<s:property value="Email"/>"
											  >
											 Edit </a> </li>
									      <li role="presentation"><a href="superUserCompanyEntityUpdate?companyid=<s:property value="companyid"/>&Email=<s:property value="Email"/>" >
											Entity List </a>  </li>
									      <li role="presentation">
									       <a href="goCommonDsrReportConfg?companyid=<s:property value="companyid"/>" >
											Common DSR Report Config</a> </li>
									       <s:if test="%{#session.emulateByCompany==null && #session.emulateByUser==null}">
									     	<li role="presentation">  
												<a role="menuitem" tabindex="-1" href="companyLoginEmulate?emulateToCompanyId=<s:property value="companyid"/>"
													 > Emulate </a>
											 </li>
											</s:if>  
									    </ul>
