...
<div class="col-sm-2"> 
 ...
 <%-- <div class="col-sm-2"> 
	<div class="form-group clearfix">
	<label class="col-sm-12 control-label"> 
	  <span>Select feilds to download</span></label>
		 <div class="col-sm-12"> 
 <select id="example-getting-started" multiple="multiple">
    ...
    <option value="HotelName">HotelName</option>
         ...
         <li class="listitems"> <div class="checkbox"><label><span>Select Report Type</span><select name="reportType"> <option value="0">Select Report Type</option><option value="T">Today</option><option value="W">Week</option><option value="M">Month</option></select></label></div></li>
          <li class="listitems"> <div class="checkbox"><label><span>Booking Date</span> <input type="text" name="fromDate" id="exctwodt2" placeholder="fromDate"><input type="text" name="toDate"  id="exctwodt1"placeholder="toDate"> </label></div></li>
          
              
     </ul> --%>
     <ul class="detectul clearfix">
        <li class="listitems"> <div class="checkbox"><label><input name="guestName" type="checkbox"   value="true"  checked="checked" > <span>GuestName</span></label></div></li>
         <li class="listitems"> <div class="checkbox"><label><input name="checkIn" type="checkbox"   value="true"  checked="checked" > <span>CheckIn</span></label></div></li>
         <li class="listitems"> <div class="checkbox"><label><input name="checkOut" type="checkbox"   value="true"  checked="checked"  >  <span>CheckOut</span></label></div></li>
         <li class="listitems"> <div class="checkbox"><label><input name="finalPrice" type="checkbox"   value="true"  checked="checked"  > <span>FinalPrice</span></label> </div></li>
            <li class="listitems"> <div class="checkbox"><label><input name="invoiceNo" type="checkbox"   value="true"  checked="checked"  > <span>InvoiceNumber</span></label> </div></li>
                  <li class="listitems"> <div class="checkbox"><label><input name="orderRef" type="checkbox"   value="true"  checked="checked"  > <span>OrderRef</span></label> </div></li>
         <li class="listitems"> <div class="checkbox"><label><input name="statusAction" type="checkbox"  value="true"  checked="checked" > <span> StatusAction</span></label></div></li>
         <li class="listitems"> <div class="checkbox"><label><input name="paymentStatus" type="checkbox"  value="true"  checked="checked"  > <span>paymentStatus</span></label></div></li>
           <li class="listitems"> <div class="checkbox"><label><input name="agency" type="checkbox"  value="true"  checked="checked"  > <span>Agency</span></label></div></li>
                <li class="listitems"> <div class="checkbox"><label><input name="hotelName" type="checkbox"  value="true"  checked="checked"  > <span>HotelName</span></label></div></li>
								...
								<div class="row">
									<div class="col-sm-8">
										...
										<a class="btn btn-primary" role="button"
											...
											aria-hidden="true"></i> Download Document
										</a>
									</div>
