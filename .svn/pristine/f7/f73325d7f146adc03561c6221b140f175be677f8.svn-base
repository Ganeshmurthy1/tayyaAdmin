			...
			<div class="row">
			 ...
			 <s:if test="%{#session.Company!=null && #session.User!=null}">  
				<s:if test="%{#session.User.userrole_id.isSuperuser()}">
					<form id="searchSuperHotelAgentCommInvoice" class="form-inline" action="searchSuperHotelAgentCommInvoiceList" method="post">
						<div class="form-group"  id="fromDateDiv" >
							<label for="exampleInputAmount">From Date</label>
							<div class="input-group">
								<input type="text" class="form-control input-sm" id="twodpd11"
									placeholder="yyyy-mm-dd" name="fromDate"
									value='<s:property value="fromDate"/>' required>
						...
						<div class="form-group"  id="endDateDiv">
							...
							<div class="input-group">
								<input type="text" class="form-control input-sm" id="twodpd12"
									placeholder="yyyy-mm-dd" name="toDate"
									value='<s:property value="toDate"/>' required>
								<div class="input-group-addon">
									<i class="fa fa-calendar"></i>
								</div>
							</div>
					 ...
					 <div class="form-group" id="user_form-group">
						...
						<div class="form-group rep-buto">
							...
							<button id="showSubmit" type="button" class="btn btn-primary">Show</button>
						</div>
 				...
 				<s:elseif test="%{#session.User.userrole_id.isUsermode() && #session.Company.companyRole.isDistributor()}">
 					<form class="form-inline" id="searchSuperHotelAgentCommInvoice" action="searchSuperHotelAgentCommInvoiceList" method="post">
						<div class="form-group"  id="fromDateDiv" >
							<label for="exampleInputAmount">From Date</label>
							<div class="input-group">
								<input type="text" class="form-control input-sm" id="twodpd11"
...
$(document).ready(function(){
	   ...
	   $('#showSubmit').click(function(){
		   $("#searchSuperHotelAgentCommInvoice").valid();
		   if($("#searchSuperHotelAgentCommInvoice").valid()){
			   document.getElementById("searchSuperHotelAgentCommInvoice").submit();
		   }
	   });
	   $("#searchSuperHotelAgentCommInvoice").validate({
