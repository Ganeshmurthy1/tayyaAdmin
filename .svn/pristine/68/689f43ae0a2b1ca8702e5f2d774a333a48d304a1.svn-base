...
<body data-ng-controller="AppCtrl">
	...
	<div class="content-wrapper">
		...
		<section class="content">
			...
			<form action="createTrawellTagConfig" method="post"
				...
				<div class="form-group">
					<label for="first-name" class="col-sm-2 control-label">UserName</label>
					<div class="col-sm-8">
				...
				<div class="form-group">
					<label for="first-name" class="col-sm-2 control-label">Sign</label>
					<div class="col-sm-8">
						<input type="text" class="form-control input-sm" id="Sign"
							name="sign" placeholder="Sign" autocomplete="off"
							required min="10" maxlength="30" required>
					</div>
				</div>
				 <div class="form-group">
					<label for="last-name" class="col-sm-2 control-label">Reference</label>
					<div class="col-sm-8">
						 <input type="text" class="form-control input-sm" id="reference" required
							name="reference" placeholder="reference" autocomplete="off"
							 >
					</div>
 					</div>
 					
 					 <div class="form-group">
					<label for="last-name" class="col-sm-2 control-label">Branch Sign</label>
					<div class="col-sm-8">
						 <input type="text" class="form-control input-sm" id="branchSign" required
							name="branchSign" placeholder="branchSign" autocomplete="off"
							 >
					</div>
 					</div>
				  <div class="form-group">
				...
				<div class="form-group text-center">
					<div class="col-xs-12 submitWrap text-center">
						<button type="button" class="btn btn-primary btn-lg" id="buttonSubmit">Add Trawell Tag Config</button>
					</div>
				</div>
			</form>
		</section>
