			...
			<section class="content">
				...
				<div class="row">
					...
					<div class="col-sm-12">	
															...
															<form action="updateVisaTravelRequest" method="post"
					...
					<div class="inner-compreg clearfix">
													...
													<div class="form-group">
														<label for="carTravelRequest.TRNo" class=" control-label">
															...
															class="form-control input-sm" id="TRNo" value='<s:property value="visaTravelRequest.TRNo"/>' required
												...
												<div class="col-sm-2">
													<div class="form-group">
														...
														<input type="text" autocomplete="off"
															name="visaTravelRequest.firstName" value='<s:property value="visaTravelRequest.firstName"/>'
															class="form-control input-sm" required="required"
												...
												<div class="col-sm-2">
													<div class="form-group">
														<label for="carTravelRequest.lastName">LastName </label> <input
															type="text" autocomplete="off" value='<s:property value="visaTravelRequest.lastName"/>'
											...
											<div class="form-group text-center">
												...
												<input type="hidden" name="visaTravelRequest.id" id="tripId" value="${visaTravelRequest.id}">
													<button type="submit" name="visaTravelRequest" value=""
														id="carTravelRequestsubmitnew"
														class="btn btn-primary btn-lg">visa Travel Request
														update</button>
												</div>
											</div>
