 ...
 <s:if test="%{#session.User.userrole_id.isSuperuser()}">
      <header class="main-header">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <form action="dashboardsearchmanager" id="headerSearch" method="post" class="ng-pristine ng-valid dashsearch">
                            ...
                            <div class="input-group col-md-11">
                                ...
                                <span class="input-group-btn">
                                   <%--  <button class="btn btn-danger" type="submit">
                                     ...
                                     <button class="btn btn-danger" type="button" id="searchId">
                                        <span class=" glyphicon glyphicon-search"></span>
                                    </button>
                                </span>
                            </div>
	...
	<div class="modal-dialog">
 	...
 	$(document).ready(function(){
		   ...
		   $('#searchId').click(function(){
			   $('.btn-danger').addClass('margTop5px');
			   $("#headerSearch").valid();
			   if($("#headerSearch").valid()){
		   ...
		   $("#headerSearch").validate({
			   submitHandler: function (form) {  
		        ...
		        highlight: function(element, errorClass, validClass) { 
		            ...
		            $(element).closest('.form-group').removeClass('has-success').addClass('has-errorWhite');
		          },
		          success: function(element) {
		            $(element).nextAll('.form-control-feedback').show().removeClass('glyphicon-remove').addClass('glyphicon-ok');
		         element.closest('.form-group').removeClass('has-error').addClass('has-success');
		         $('.btn-danger').removeClass('margTop5px');
		            $(element).remove();
		          }
		   })
 	});
