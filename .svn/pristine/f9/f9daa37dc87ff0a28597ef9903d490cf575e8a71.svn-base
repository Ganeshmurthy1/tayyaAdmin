	...
	<section class="content">
		...
		<input type="hidden"
				...
				<input type="hidden"
					...
					id="user_id">
			<form action="HotelBookAndSearchView" method="post" id="filterform">
								...
								<tr>
									...
									<td>
										<p data-placement="top">
											<a href="HotelLookList?configIds=<s:property value="configId"/>&searchType=hotel&companyId=<s:property value="companyId"/>"
												class="btn btn-success btn-xs" > Look
											</a> <a href="HotelBookList?configIds=<s:property value="configId"/>&searchType=hotel&companyId=<s:property value="companyId"/>"
