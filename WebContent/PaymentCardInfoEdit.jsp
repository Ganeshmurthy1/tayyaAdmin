	...
	<div class="content-wrapper">
		...
		<section class="content">
			...
			<div class="row" id="dash-us-register">
			 <form id="updatePaymentCardInfoForm" action="updatePaymentCardInfo" method="post" class="form-horizontal"
					name="myForm">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="email" class="form-control input-sm maiIDClr"
					...
					<div class="form-group text-center">
						<div class="col-xs-12 submitWrap text-center">
							...
							<button type="button" id="paymentCardSubmit" class="btn btn-primary btn-lg">Update</button>
						</div>
					</div>
				</form> 
			</div>
...
<%@ include file="DashboardFooter.jsp"%>
	...
	$(document).ready(function(){
		   ...
		   $('#paymentCardSubmit').click(function(){
			   $("#updatePaymentCardInfoForm").valid();
			   if($("#updatePaymentCardInfoForm").valid()){
				   document.getElementById("updatePaymentCardInfoForm").submit();
			   }
		   });
		 		   
		   $("#updatePaymentCardInfoForm").validate({
