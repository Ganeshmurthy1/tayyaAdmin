...
<div class="content-wrapper" ng-app="airDataApp">
	...
	<section class="content-header">
		...
		<h1>
			Dashboard <small> Bus Panel</small>
			<i class="fa fa-bus"></i>
		</h1>
				...
				<div class="row">
					...
					<div class=" col-md-4" ng-controller="BookingConfirmCtrl">
						...
						<div class="small-box bg-green">
							...
							<div class="small-week small-box-footer">
								<label class="btn btn-transparent grey-salsa btn-sm "><span
									style="color: aqua; font-size: 15px">{{confirmedCount.countD}}</span>&nbsp;&nbsp;&nbsp;
									<a
									href="showIndividualBusReportList?showReportType=BC&filterUptoDate=D"
									class="small-box-footer"> Today <i
										class="fa fa-arrow-circle-right"></i></a> </label> <label
									class="btn btn-transparent grey-salsa  btn-sm "><span
									style="color: aqua; font-size: 15px">{{confirmedCount.countW}}</span>&nbsp;&nbsp;&nbsp;
									<a
									href="showIndividualBusReportList?showReportType=BC&filterUptoDate=W"
									class="small-box-footer">Week<i
										class="fa fa-arrow-circle-right"></i></a> </label> <label
									class="btn btn-transparent grey-salsa btn-sm "><span
									style="color: aqua; font-size: 15px">{{confirmedCount.countM}}</span>&nbsp;&nbsp;&nbsp;
									<a
									href="showIndividualBusReportList?showReportType=BC&filterUptoDate=M"
									class="small-box-footer">Month <i
										class="fa fa-arrow-circle-right"></i></a> </label>
							</div>
						</div>
					</div>
					...
					<div class=" col-md-4" ng-controller="OrderPaymentSuccessCtrl">
						...
						<div class="small-box bg-blue">
							...
							<div class="small-week small-box-footer">
								<label class="btn btn-transparent grey-salsa btn-sm "><span
									style="color: aqua; font-size: 15px">{{successCount.countD}}</span>&nbsp;&nbsp;&nbsp;
									<a
									href="showIndividualBusReportList?showReportType=PS&filterUptoDate=D"
									class="small-box-footer"> Today <i
										class="fa fa-arrow-circle-right"></i></a> </label> <label
									class="btn btn-transparent grey-salsa  btn-sm "><span
									style="color: aqua; font-size: 15px">{{successCount.countW}}</span>&nbsp;&nbsp;&nbsp;
									<a
									href="showIndividualBusReportList?showReportType=PS&filterUptoDate=W"
									class="small-box-footer">Week<i
										class="fa fa-arrow-circle-right"></i></a> </label> <label
									class="btn btn-transparent grey-salsa btn-sm "><span
									style="color: aqua; font-size: 15px">{{successCount.countM}}</span>&nbsp;&nbsp;&nbsp;
									<a
									href="showIndividualBusReportList?showReportType=PS&filterUptoDate=M"
									class="small-box-footer">Month <i
										class="fa fa-arrow-circle-right"></i></a> </label>
							</div>
						</div>
					...
					<div class=" col-md-4" ng-controller="OrderPaymentFailedCtrl">
						...
						<div class="small-box bg-red">
							...
							<div class="small-week small-box-footer">
								<label class="btn btn-transparent grey-salsa btn-sm "><span
									style="color: aqua; font-size: 15px">{{failedCount.countD}}</span>&nbsp;&nbsp;&nbsp;
									<a
									href="showIndividualBusReportList?showReportType=PF&filterUptoDate=D"
									class="small-box-footer"> Today <i
										class="fa fa-arrow-circle-right"></i></a> </label> <label
									class="btn btn-transparent grey-salsa  btn-sm "> <span
									style="color: aqua; font-size: 15px">{{failedCount.countW}}</span>&nbsp;&nbsp;&nbsp;
									<a
									href="showIndividualBusReportList?showReportType=PF&filterUptoDate=W"
									class="small-box-footer">Week<i
										class="fa fa-arrow-circle-right"></i></a>
								</label> <label class="btn btn-transparent grey-salsa btn-sm ">
									<span style="color: aqua; font-size: 15px">{{failedCount.countM}}</span>&nbsp;&nbsp;&nbsp;
									<a
									href="showIndividualBusReportList?showReportType=PF&filterUptoDate=M"
									class="small-box-footer">Month <i
										class="fa fa-arrow-circle-right"></i></a>
								</label>
							</div>
					...
					<div class="panel-heading clearfix">
						...
						<ul class="nav nav-tabs" role="tablist">
							<li role="presentation" class="active"><a
								href="#flightsconfirmedmodel"
								aria-controls="flightsconfirmedmodel" role="tab"
								data-toggle="tab">Confirmed Booking</a></li>
			...
			<div class="col-sm-12">
				<div class="panel panel-default">
					<div class="panel-heading clearfix">
						...
						<ul class="panel-controls" style="margin-top: 2px;">
							<li><a href="#" ng-click="refreshBus()"
								class="panel-refresh"><span class="fa fa-refresh"></span></a></li>
							<li><a href="#" class="panel-fullscreen"><span
									class="fa fa-expand"></span></a></li>
						</ul>
...
<script>
	...
	app.controller('BookingConfirmCtrl', function($scope, $http) {
		...
		$http.get(baseUrl + "getBusAnalysisJson?bstatus=HK").then(
				function(response) {
					...
					var barChartConfirmedData = {
						...
						datasets : [ {
							...
							data : [ response.data.jsonobj.countD,
									response.data.jsonobj.countW,
									response.data.jsonobj.countM ]
						} ]

					}

					var ctx = document.getElementById("flightconfirmed")
							.getContext("2d");
	...
	app.controller('OrderPaymentSuccessCtrl', function($scope, $http) {
		...
		$http.get(baseUrl + "getBusAnalysisJson?pstatus=PS").then(
				function(response) {
	...
	app.controller('OrderPaymentFailedCtrl', function($scope, $http) {
		...
		$http.get(baseUrl + "getBusAnalysisJson?pstatus=PF").then(
				function(response) {
	...
	app.controller('OrderChartCtrl', function($scope, $http) {
		var currentUrl = $(location).attr('href');
		var baseUrl = currentUrl.substr(0, currentUrl.lastIndexOf('/') + 1);
		$http.get(baseUrl+"getBusAnalysisJson?bstatus=ALL&type=D").then(function(response) {
		...
		$scope.getWeeklyConfirmed=function(){
			$http.get(baseUrl+"getBusAnalysisJson?bstatus=ALL&type=W").then(function(response) {
				$('.doughnutDefault').hide();
				$('.doughnutDay').hide();
				$('.doughnutWeek').show();
				$('.doughnutMonth').hide();
	  ...
	  $scope.getMonthlyConfirmed=function(){
		   $http.get(baseUrl+"getBusAnalysisJson?bstatus=ALL&type=M").then(function(response) {
			   $('.doughnutDefault').hide();
				$('.doughnutDay').hide();
				$('.doughnutWeek').hide();
				$('.doughnutMonth').show();
