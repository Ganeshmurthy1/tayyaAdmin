...
<div class="content-wrapper">
	...
	<section class="content-header">
		<div class="row">
			...
			<s:if
				test="%{#session.Company.companyRole.isCorporate() ||#session.Company.companyRole.isSuperUser()}">
						...
						<div class="col-sm-12 clearfix pull-right " data-placement="top">
							<div class="row">
								<div class="col-sm-10 clearfix " data-placement="top">
									<a href="goTrips" class="btn btn-top-link btn-xs"> All
										Trips </a> <a href="HotelTravelRequestList"
										class="btn btn-top-link btn-xs"> Hotel Trips </a> <a
										href="FlightTravelRequestList" class="btn btn-top-link btn-xs">
										Flight Trips </a> <a href="CarTravelRequestList"
										...
										Visa Trips </a> <a href="InsuranceTravelRequestList"
										class="btn btn-top-link btn-xs"> Insurance Trips </a>
								</div>
	...
	<div id="voucherModal" class="modal fade" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<span style='color: red; font-size: 15px'>* Please separate
					emails with semicolon </span>
				...
				<div class="modal-footer">
					...
					<button type="button"
						onclick="sendOfflineVoucherOrInvoiceToMail('voucher','<s:property value="busOrderRow.orderId"/>');"
						class="btn btn-primary btn-sm">SEND VOUCHER</button>
	...
	<div id="invoiceModal" class="modal fade" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button"
						onclick="sendOfflineVoucherOrInvoiceToMail('invoice','<s:property value="busOrderRow.orderId"/>');"
	...
	<section class="content">
		<div class="col-sm-12 no-print">
			<div class="col-sm-6">
				<a data-toggle="modal" href="#voucherModal"
					class="btn btn-success btn-xs">Send Voucher Via Email</a>
				<s:if
					test="%{#session.Company.companyRole.isCorporate() ||#session.Company.companyRole.isSuperUser()}">
					<a data-toggle="modal" href="#invoiceModal"
						class="btn btn-warning btn-xs">Send Invoice Via Email</a>
				</s:if>
				<a href="#" class="btn btn-warning btn-xs"
					onclick="printDiv('display-api-content')">print</a> <a
					href='<s:text name="global.resourceApiUrl"></s:text>getpdf/hotel?orderids=${busOrderRow.orderId}'
		...
		<div class="row">
			<div class="col-sm-12 clearfix hotel-offline-vocher">
...
<script>
	...
	function calldataplugin(sessionKey)
	{
		...
		//var formURL ="https://devlintas.tayyarah.com/devtayyarahapi/Email/getHtmlTemplateById?orderid=${hotelReport.hotelOrderRow.orderReference}&emailType=1";
		  //var formURL = "http://localhost:8081/LintasTravelAPI/Email/getHtmlTemplateById?orderid=${hotelReport.hotelOrderRow.orderReference}&emailType=1"; 
		 //var formURL = "https://devlintas.tayyarah.com/devtayyarahapi/Email/getHtmlTemplateById?orderid=${hotelReport.hotelOrderRow.orderReference}&emailType=1"; 
		  ...
		  $.ajax({
				...
				success : function(response,textStatus,jqXHR) {
					ApiURL=  response.ApiResourceURL  
					 var formURL = ApiURL+"/Email/getHtmlTemplateById?orderid=${busOrderRow.orderId}&emailType=88";  
