...
<body data-ng-controller="AppCtrl">
	...
	<div class="content-wrapper">
		...
		<div class="clearfix">
			...
			<h4><b>Flight Supplier Payment Details</b></h4> 
			</div>
...
<%-- 		<div class="col-sm-9 clearfix pull-right " data-placement="top">
		...
		<%-- <section class="content-header"> 
			...
			<h3>Flight Supplier Payment Details</h3> 
...
<div class="border-common">
				<p class="h4">
					<b>Add Supplier Payment ${apiProviderPaymentTransaction.balance}</b>
				</p>
			</div>
			<div class="col-sm-12">
				<form action="insertFlightApiProviderPaymentTxDetail" method="post"
					class="clearfix" name="myForm" id="supplierPaymentForm">
			  <input type="hidden" value="${apiProviderPaymentTransaction.id}" name="apiProviderPaymentTransaction.id"> 
					<div class="clearfix" id="payment">
					<input
									type="hidden"  value="${apiProviderPaymentTransaction.api_transaction_id}" name="apiTransactionId"  >
						<%-- <div class="commonone clearfix">
							<div class="form-group clearfix">
								<label class=" control-label">TransactionId</label> <input
									type="text" class="form-control" value="${apiProviderPaymentTransaction.api_transaction_id}"
						...
						<div class="commonone clearfix">
								...
								<select  class="form-control input-sm" id="supplierPaymentMethod"
						...
						<div class="commonone clearfix">
							<div class="form-group clearfix">
								...
								<select class="form-control input-sm"  
															name="supplierCardHolderId"  id="holderName" required>
						...
						<div class="commonone clearfix">
							<div class="form-group clearfix">
								<label class="control-label">Amount</label> <input type="text" class="form-control"  
								placeholder="Amount" value="${apiProviderPaymentTransaction.balance}${paymentTransaction.currency}" id="payBalance" 
									autocomplete="off" name="amount" required onkeypress="return isNumberKey(event,this);">
						...
						<div class="commonone clearfix client-comments"    style="display: none">
							<div class="form-group clearfix">
								...
								<textarea rows="2" cols="2" class="form-control" style="width: 480px;height: 36px;"
									placeholder="paymentInformation" name="paymentInformation"></textarea>
							</div>
						</div>
						<div class="col-sm-12">
							<div class="form-group text-right">
								<input type="button" class="btn btn-primary btn-lg" value="AddPayment" id="add-pay">
							</div>
						</div>
					</div>
				</form>
					...
					<table class="table table-bordered">
						...
						<s:iterator value="apiProviderpaymentTransactionDetailList" status="loopCount">
						  <tr>
								...
								<td><s:property value="balance"/> <s:property value="currency"/></td>
...
$(function() {
	...
	if(supplierPaymentMethod=='cash' || supplierPaymentMethod=='online' ){
...
$("#paymentNotificationAlert").click( function() {
    ...
    var ccEmails= $('#ccEmails').val();
    	$.ajax({	
                url: 'insertFlightSupplierPaymentTxHistory',
                type: 'post',
