					...
					<form action="companyFlightOrderList" method="post" id="filterform">
						...
						<div class="col-sm-12">
							<div class="row">
								...
								<!-- <input class="btn" type="button" id="save_value" name="save_value" value="Download" /> -->
								...
								<table id="example" class="table table-striped table-bordered">
									...
									<tbody>
										...
										<s:iterator value="flightReportPage.items" status="rowCount">
											...
											<tr>
												<%-- <td><s:if test="status=='Confirmed' || status=='Cancelled'"><input type="checkbox" class="ads_Checkbox"  name="checkBox[]" id="checkBox<s:property value="id" />" value="<s:property value="orderId" />"> </s:if> </td>
...
$('.ads_Checkbox').click(function(){
    ...
    $('.ads_Checkbox:checked').each(function(){        
        allValsprimary.push($(this).val());
    });
    if(allValsprimary.length > 0){
    	 $('#save_value').show();
    }else{
    	$('#save_value').hide();
    }
		...
		success : function(response) {
			...
			//console.log("finalUrl",finalUrl);
			  $.ajax({
				    method: "GET",
				    url:finalUrl,
				    data:{orderid:allOrderIds,loginId:loginId,travelCode:1},
