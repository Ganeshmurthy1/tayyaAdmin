...
<body>
			...
			<div class="row">
				...
				<s:if test="%{#session.Company!=null && #session.User!=null}">
					...
					<input type="hidden"
						...
						id="user_id">
					<form action="companyCarReports" method="post" id="filterform">
												...
												<%-- <div class="col-sm-4">
													<div class="form-group clearfix">
														<label class="col-sm-12 control-label">Created
															Date</label>
														<div class="col-sm-6">
															<input type="text" class="form-control" id="createddt1"
																placeholder="From Date(dd-mm-yyyy)"
																name="commonReportPage.flightReportFilter.fromDate"
																value='<s:property value="commonReportPage.flightReportFilter.fromDate"/>'>

														</div>
														<div class="col-sm-6">
															<input type="text" class="form-control" id="createddt2"
																placeholder="To Date(dd-mm-yyyy)"
																name="commonReportPage.flightReportFilter.toDate"
																value='<s:property value="commonReportPage.flightReportFilter.toDate"/>'>
														</div>
										...
										<thead>
											...
											<s:iterator value="commonReportPage.items" status="rowCount">
												<tr>
													...
													<td>
													<c:choose>
														<c:when test="${confirmationNumber!=null}">
	...
	<script>
		$(document).ready(function() {
			...
			$('#createddt1').datepicker({
				dateFormat : "dd-mm-yy",
				changeMonth : true,
				changeYear : true,
			});

			$('#createddt2').datepicker({
				dateFormat : "dd-mm-yy",
				changeMonth : true,
				changeYear : true,
			});
