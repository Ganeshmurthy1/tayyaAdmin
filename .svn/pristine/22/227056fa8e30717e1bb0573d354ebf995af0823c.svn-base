								...
								<div class="table-responsive dash-table">
									<div class="box clearfix">
										<table id="example" class="table table-striped table-bordered"
											...
											<tbody>
												<s:iterator value="hotelDetails.rooms" status="rowCount">
													<tr>
													<td><s:property value="%{#rowCount.count}" /></td>
													 <td><s:property value="hotelDetails.name"/></td>
															 <td><s:property value="basePrice" /></td>
															  <td><s:property value="taxPrice" />  
															<td><s:property value="extraBedPrice" /></td>
															 <td><s:property value="startDate" />  
															<td><s:property value="endDate" /></td>
															<td><s:property value="cancelBeforeDay" /></td>
															<td><s:property value="cancelAmount" /></td>
															<td>
																<a href="hotelRoomEdit?id=<s:property value="id"/>"
