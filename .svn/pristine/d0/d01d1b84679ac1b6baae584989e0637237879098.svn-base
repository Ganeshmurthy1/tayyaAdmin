		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
						...
						<div class="row">
							<div class="col-sm-12">
								<input type="hidden" id="carid"
									value="<s:property value="carOrderRow.orderId"/>">
								<div class="col-sm-6">
				...
				<div class="modal-footer">
					<button type="button"
						onclick="sendCarOfflineVoucherOrInvoiceToMail('invoice','<s:property value="carOrderRow.orderId"/>');"
		...
		<div class="col-sm-12 no-print">
			<div class="col-sm-6">
				<a data-toggle="modal" href="#invoiceModal"
					...
					<!--  <a href="#" onclick="pdf()" class="btn btn-success btn-xs"   >
															Pdf </a> -->
			<a href='<s:text name="global.resourceApiUrl"></s:text>getpdf/invoice?orderid=<s:property value="carOrderRow.orderId"/>&travelcode=4' class="btn btn-success btn-xs"   >
															Pdf </a>  
		  ...
		  $.ajax({
				...
				success : function(response,textStatus,jqXHR) {
					...
					var orderid = $("#carid").val();
					  var formURL = ApiURL+"Email/getHtmlTemplateById?orderid="+orderid+"&emailType=64";
		
		//var orderId=${carOrderRow.orderId};
		
		
		//var formURL = "https://devlintas.tayyarah.com/devtayyarahapi/Email/getHtmlTemplateById?orderid="+orderid+"&emailType=64";
		//var formURL = "http://localhost:8081/LintasTravelAPI/Email/getHtmlTemplateById?orderid="+orderid+"&emailType=64";
...
<script type="text/javascript">
       ...
       function sendCarOfflineVoucherOrInvoiceToMail(type,orderId) {
        	var toEmails= null;
        	var ccEmails= null;
        	if(type=='voucher'){
