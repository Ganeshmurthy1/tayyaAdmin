...
<body data-ng-controller="AppCtrl">
										...
										<div class="companysetup clearfix"> 
											...
											<s:if test="%{#session.Company.companyEntities!=null && #session.Company.companyEntities.size()>0}"> 
												<div class="col-sm-2">
														...
														<select class="form-control input-sm" onchange="getEntity(this)" name="carOrderRow.companyEntityId" id="entity" required="required">
												...
												<div class="col-sm-2">
													<div class="form-group has-feedback">
														<label for="carOrderRow.supplierName">Supplier
															Name</label> <select class="form-control input-sm"
											...
											<div class="detailswithRM">  	 
												<div class="col-sm-2">
													<div class="form-group has-feedback">
														<label for="busTravelRequest.title">Title</label> <select
															class="form-control input-sm" required="required"
															name="carOrderCustomerList[0].title">
												...
												<div class="col-sm-2">
													<div class="form-group has-feedback">
														<label for="carOrderCustomerList.firstName"
															class=" control-label">First Name</label> <input
															type="text" autocomplete="off"
															name=carOrderCustomerList[0].firstName
												...
												<div class="col-sm-2">
													<div class="form-group has-feedback">
														<label for="carOrderCustomerList.lastName"
															class=" control-label">Last Name </label> <input
															type="text" autocomplete="off"
															name=carOrderCustomerList[0].lastName
								...
								<div class="col-sm-2">
									<div class="form-group has-feedback">
										<label for="empCode" class=" control-label"> ${fieldName[0]}</label> <input type="text"
											autocomplete="off" name="carOrderCustomerList[0].rmConfigTripDetailsModel.manualField1"
											class="form-control input-sm "  required="required"
								...
								<div class="col-sm-2">
									<div class="form-group has-feedback">
										<label for="empCode" class=" control-label"> ${fieldName[1]}</label> <input type="text"
											autocomplete="off" name="carOrderCustomerList[0].rmConfigTripDetailsModel.manualField2"
											class="form-control input-sm " required="required"
								...
								<div class="col-sm-2">
									<div class="form-group has-feedback">
										<label for="empCode" class=" control-label"> ${fieldName[2]}</label> <input type="text"
											autocomplete="off" name="carOrderCustomerList[0].rmConfigTripDetailsModel.manualField3"
											class="form-control input-sm " required="required"
								...
								<div class="col-sm-2">
									<div class="form-group has-feedback">
										<label for="empCode" class=" control-label"> ${fieldName[3]}</label> <input type="text"
											autocomplete="off" name="carOrderCustomerList[0].rmConfigTripDetailsModel.manualField4"
											class="form-control input-sm " required="required"
								...
								<div class="col-sm-2">
									<div class="form-group has-feedback">
										<label for="empCode" class=" control-label"> ${fieldName[4]}</label> <input type="text"
											autocomplete="off" name="carOrderCustomerList[0].rmConfigTripDetailsModel.manualField5"
											class="form-control input-sm "  required="required"
													...
													<div class="col-sm-2">
														<div class="form-group has-feedback">
															<label for="carTravelRequest.TRNo"  >
																...
																autocomplete="off" name=carOrderCustomerList[0].rmConfigTripDetailsModel.trNumber
											...
											<div class="col-sm-2" >
													<div class="form-group has-feedback">
														<label for="empCode" class=" control-label"> Emp Code</label> <input
															type="text" autocomplete="off"
															name="carOrderCustomerList[0].rmConfigTripDetailsModel.empCode"
											...
											<div class="col-sm-2"  >
													<div class="form-group has-feedback">
														<label for="empCode" class=" control-label"> Department</label> <input
															type="text" autocomplete="off"
															name="carOrderCustomerList[0].rmConfigTripDetailsModel.department"
											...
											<div class="col-sm-2" >
													<div class="form-group has-feedback">
														<label for="empCode" class=" control-label">Cost Center</label> <input
															type="text" autocomplete="off"
															name="carOrderCustomerList[0].rmConfigTripDetailsModel.costCenter"
											...
											<div class="col-sm-2" >
													<div class="form-group has-feedback" >
														<label for="empCode" class=" control-label">Approver Name</label> <input
															type="text" autocomplete="off"
															name="carOrderCustomerList[0].rmConfigTripDetailsModel.approverName"
											...
											<div class="col-sm-2"  >
													<div class="form-group has-feedback">
														<label for="empCode" class=" control-label">location</label> <input
															type="text" autocomplete="off"
															name="carOrderCustomerList[0].rmConfigTripDetailsModel.location"
											...
											<div class="col-sm-2" >
													<div class="form-group has-feedback">
														<label for="empCode" class=" control-label">Bussiness Unit</label> <input
															type="text" autocomplete="off"
															name="carOrderCustomerList[0].rmConfigTripDetailsModel.bussinessUnit"
											...
											<div class="col-sm-2"  >
													<div class="form-group has-feedback">
														<label for="projectCode" class=" control-label"> Project Code</label> <input
															type="text" autocomplete="off"
															name="carOrderCustomerList[0].rmConfigTripDetailsModel.projectCode"
											...
											<div class="col-sm-2"  >
													<div class="form-group has-feedback">
														<label for="reasonForTravel" class=" control-label">Reason For Travel</label> <input
															type="text" autocomplete="off" id="rmreasonForTravel"
															name="carOrderCustomerList[0].rmConfigTripDetailsModel.reasonForTravel"
											...
											<div class="col-sm-2"  >
													<div class="form-group has-feedback" >
														<label for="billNonBill" class=" control-label">Billing/Non Billing</label> <input
															type="text" autocomplete="off"
															name="carOrderCustomerList[0].rmConfigTripDetailsModel.billNonBill"
														...
														<div class="col-sm-2"> 
																<div class="form-group has-feedback">
																	<label for="busOrderRow.supplierPrice"
																		...
																		type="text" autocomplete="off"
																		name=carOrderCustomerList[0].rmConfigTripDetailsModel.supplierAmount
																		class="form-control input-sm" id="supplierFare" value="0"
															...
															<div class="col-sm-2">
																<div class="form-group has-feedback"><%-- ${flightQuotation.totalAmount} --%>
																	<label for="hotelName" class=" control-label">Base
																		...
																		id="baseFare"
																		name="carOrderCustomerList[0].rmConfigTripDetailsModel.baseAmount"
															...
															<div class="col-sm-2">
																<div class="form-group has-feedback">
																	<label for="hotelName" class=" control-label notone">Tax
																	 ...
																	 id="taxFare" value="0"
																		name="carOrderCustomerList[0].rmConfigTripDetailsModel.tax"
															...
															<div class="col-sm-2">
																<div class="form-group has-feedback">
																	<label for="hotelName" class=" control-label notone1">Markup
																		...
																		name="carOrderCustomerList[0].rmConfigTripDetailsModel.markUp"
										...
										<div class="pricee-details"> 
											...
											<div class="col-sm-2">
												<div class="form-group">
													<label for="carOrderRow.supplierPrice"
														...
														required placeholder="Enter Supplier Price" readonly="readonly">
												</div>
											</div>
											...
											<div class="form-group">
												<label for="carOrderRow.basePrice"  >
													...
													required placeholder="Enter Base Price" readonly="readonly">
											</div>
											</div>
											...
											<div class="form-group has-feedback">
												<label for="carOrderRow.extraKM" >
													...
													name="carOrderRow.extraKM" class="form-control input-sm cusValidationforprice"
											...
											<div class="form-group has-feedback">
												<label for="carOrderRow.extraHours" >
													...
													class="form-control input-sm cusValidationforprice" id="extraHours" value="0"
										...
										<div class="col-sm-2"> 
											<div class="form-group has-feedback">
												<label for="carOrderRow.tollOrParkingCharges"
													...
													type="text" autocomplete="off" onChange="addtax()"
													  name="carOrderRow.tollOrParkingCharges"
													class="form-control input-sm cusValidationforprice" id="tollOrParkingCharges"
										...
										<div class="col-sm-2"> 
											...
											<div class="form-group has-feedback">
												<label for="carOrderRow.driverAllowanceDay"
													...
													class="form-control input-sm cusValidationforprice" id="driverAllowanceDay"
													value="0" required onchange="addtax()"
											...
											<div class="form-group has-feedback">
												<label for="carOrderRow.driverAllowanceNight"
													...
													class="form-control input-sm cusValidationforprice" id="driverAllowanceNight"
													value="0" required onchange="addtax()"
											...
											<div class="form-group">
												<label for="carOrderRow.otherTaxes" >
													...
													required placeholder="Enter Other Taxes " readonly="readonly">
											</div>
											</div>
											<div class="col-sm-2"> 
											<div class="form-group">
												<label for="carOrderRow.markUp" >Mark
													...
													placeholder="Enter Management Fee" readonly="readonly">
											</div>
											</div>
  ...
  <div class="modal-dialog">
	...
	$(document).ready(function(){
		    ...
		    $("#carexpensesFormId").validate({
		     ...
		     $('#carTravelRequestsubmitnew').click(function() {
		        ...
		        console.log($("#carexpensesFormId").valid());
	...
	function add(currentObj) { 
		...
		$('#quoteamount').val(totalManagementFee);
		 ...
		 for (var i = noOfRooms; i <= noOfRooms; i++) {
			  ...
			  $rooms.find("h4.panel-title a[href='#collapseinside']").attr("href", "#collapseinside" + (i));
				...
				$rooms.find(".inner-compreg .form-group input[name^=carOrderCustomerList]").each(function() {
				...
				$rooms.find(".inner-compreg .form-group select[name^=carOrderCustomerList]").each(function() {
					var name = $(this).attr('name');
					var indexOfThirdBracket = name.indexOf('[') + 1;
					name = name.substring(0,
							indexOfThirdBracket)
				...
				$rooms.find(".price-details .form-group input[name^=carOrderCustomerList]").each(function() {
	 ...
	 $('#tollOrParkingCharges,#driverAllowanceDay,#driverAllowanceNight').keyup(function(){
		 addtax();
		});
	</script>
</body>
