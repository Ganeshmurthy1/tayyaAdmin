...
app.controller('AppCtrl',function($scope, fileReader,$http) {
	/* var lic=$location.protocol();
	 ...
	 finalUrl = newUrl+"UploadDeal.action";
       ...
       .success(function(data){ 
    	   ...
    	   if(data.jsonobj.ImageUrl!=null){
               ...
               .then(function(result) {  
              	...
              	//newUrl+"DealImages/"+
              	  $scope.imageSrc = newUrl+"DealImages/"+data.jsonobj.ImageUrl;
               });
...
app.directive("ngFileSelect",function(){
 ...
 return {
   link: function($scope,el,fileReader){
     ...
     el.bind("change", function(e){
       ...
       reader.onload = function (e) {
           ...
           image.onload = function () {
              ...
              // console.log(height);
              // console.log(width);
               if (height > 497 || width > 333) {
            	   $scope.fileError1 = "Image Height must be 497px and Width must be 333px.";          
               }
