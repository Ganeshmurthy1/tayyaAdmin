	...
	<div class="content-wrapper">
		...
		<section class="content">
			...
			<div class="row" id="dash-us-register">
			 ...
			 <form id="Airport_UpdateForm" action="Airport_Update" method="post" class="form-horizontal"
					name="myForm">
					<s:if test="hasActionErrors()">
					...
					<div class="form-group text-center">
						<div class="col-xs-12 submitWrap text-center">
							<button id="Airport_UpdateSubmit" type="button" class="btn btn-primary btn-lg">Update</button>
						</div>
					</div>
				</form> 
			</div>
...
<script>
		$(document).ready(function(){
			   ...
			   $('#Airport_UpdateSubmit').click(function(){
				   $("#Airport_UpdateForm").valid();
				   if($("#Airport_UpdateForm").valid()){
					   document.getElementById("Airport_UpdateForm").submit();
				   }
			   });
			   $("#Airport_UpdateForm").validate({
