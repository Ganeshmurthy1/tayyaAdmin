...
<!-- Main content -->
  <section class="content">
          	...
          	<div class="col-sm-6"> 
          		...
          		<a href='<s:text name="global.resourceApiUrl"></s:text>getpdf/invoice?orderid=<s:property value="hotelReport.hotelOrderRow.orderReference"/>&travelcode=2' class="btn btn-success btn-xs"   >
															Pdf </a> 
          	</div>
          	<div class="col-sm-6">
						<h4 >
		  ...
		  $.ajax({
				...
				success : function(response,textStatus,jqXHR) {
					ApiURL=  response.ApiResourceURL
					  var formURL = ApiURL+"Email/getHtmlTemplateById?orderid=${hotelReport.hotelOrderRow.orderReference}&emailType=63";    
		
		
	/* 	//var formURL ="https://devlintas.tayyarah.com/devtayyarahapi/Email/getHtmlTemplateById?orderid=${hotelReport.hotelOrderRow.orderReference}&emailType=63"; */
		 // var formURL = "http://localhost:8090/LintasTravelAPI/Email/getHtmlTemplateById?orderid=${hotelReport.hotelOrderRow.orderReference}&emailType=1"; 
