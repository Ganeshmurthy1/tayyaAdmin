...
<body data-ng-controller="bookcontroller" >
	<div class="content-wrapper">
		...
		<section class="content-header">
			<h1>Insurance Passenger Details </h1>
		</section>
  <!-- Main content -->
		<section class="content">
			...
			<!-- 		<form class="form-inline" action="" method="post"> -->
				 ...
				 <div class="flight-admin-details">
                     <h3><span>Insurance Details:-</span></h3>
								...
								<table class="table table-striped table-bordered"
									...
									<tbody>
 										<tr> 
											 <td><s:property value="insuranceOrderRow.confirmationNumber"/></td>
												<td><s:property value="insuranceOrderRow.invoiceNo" /></td>
												<td><s:property value="insuranceOrderRow.bookingCurrency" /></td>
 												<td><s:property value="insuranceOrderRow.orderId"/></td>
 												<td><s:property value="insuranceOrderRow.statusAction" /></td>
												<td><s:property value="insuranceOrderRow.paidBy" /></td>
												<td><s:property value="insuranceOrderRow.remarks" /></td>
								...
								<table class="table table-striped table-bordered"
									...
									<tbody>
											  <s:iterator value="insuranceOrderRow.orderCustomer">
											<tr>
