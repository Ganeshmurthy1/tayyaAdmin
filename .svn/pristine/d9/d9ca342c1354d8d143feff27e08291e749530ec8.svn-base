...
<%-- 					<div class="col-sm-9 clearfix pull-right " data-placement="top">
			...
			<section class="content">
				...
				<div class="row">
					...
					<div class="col-sm-12"> 
					<form action="updateVisaQuotation" method="post" 	class="form-horizontal" name="carexpensesFormId"
											id="visaExpensesFormId"> 
					...
					<div class="inner-compreg clearfix">
						<div class="col-sm-2">
									<div class="form-group">
														...
														</label> <select class="form-control input-sm" required
											...
											<div class="form-group text-center">
												...
												<input type="hidden" name="visaTravelRequestQuotation.id"  value="${visaTravelRequestQuotationlist[0].id}">
...
$('#buttonSubmit').click(function() {
	   if($("#visaExpensesFormId").valid())
	    	document.getElementById("visaExpensesFormId").submit();
	}); 
});
</script>  
</body>
