...
<div class="content-wrapper">
	...
	<section class="content">
		...
		<div class="row">
			<form  action="getAllDistributors" method="post" id="filterform">
		<div class="clearfix">
		<div class="col-sm-12">
					...
					<tbody>
						<s:iterator value="companyFilterPage.companyList" status="rowCount" >
							...
							<tr>
								...
								<td>
									<form action="setDisCompanyLock" method="post">
										<input type="hidden" name="companyid"
...
$(function() {
	...
	if(lastpath =="getAllCorporate"){
		 $("#listtitle").text("Corporate List");
		 $('#filterform').attr('action', 'getAllCorporate');
		 $("#searchcor").text("Corporate List");
		 ...
		 $.ajax({
				...
				success : function(data, textStatus, jqXHR) {
					console.log("for corporate",data.records);
					var items = data.records;
					for (var i = 0; i < data.records.length; i++) {
						  if(items[i].companyRole.corporate == true ){ 
							// console.log("for corporate con",items[i].companyRole.corporate)
							/*  if(items[i].companyRole.corporate =="true"){ */
		 ...
		 $("#listtitle").text("Distributor List");
		 $('#filterform').attr('action', 'getAllDistributors');
	}
	
	var totUrl=$(location).attr('href');
	var newUrl=totUrl.substr(0,totUrl.lastIndexOf('/')+1);
	  var finalUrl = newUrl+"getAllDistributors";
