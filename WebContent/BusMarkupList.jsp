...
<div class="content-wrapper">
	...
	<section class="content">
		...
		<div class="row">
			<form action="busMarkupList" method="post" id="filterform">
				<div class="clearfix">
					<div class="col-sm-12">
				...
				<div class="table-responsive dash-table">
					<table id="mytable" class="table table-striped ddd"
						...
						<tbody>
							<s:iterator value="companyFilterPage.busMarkupList" status="rowCount"
								var="myobj">
								<tr>
								 ...
								 <td><s:property value="markupName" /></td>
									...
									<td>
										<p data-placement="top" title="edit">
											<a
												href="markupBusProfile?markupId=<s:property value="markupId"/>"
...
<script type="text/javascript">
	function userDelete(id) {
		...
		var finalUrl = newUrl + "deleteBusMarkupList";
