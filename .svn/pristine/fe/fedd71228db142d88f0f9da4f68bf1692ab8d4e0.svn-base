...
<div class="content-wrapper">
	...
	<section class="content-header">
			<h1>Train Order View</h1>
		</section>
	
	<section class="content">
		<div class="col-sm-12">
				<h4>
					<a href="companyTrainOrders"><span class="pull-right"><i
	...
	<div class="row">
					...
					<div class="table-responsive dash-table">
						...
						<div class="box clearfix">
							...
							<div class="modal-body">
								...
								<tr>
								<th>Order Id</th>
									<th>Train Confirmation Number</th>
									...
									<tr>
										<th><s:property
													value="trainOrderRow.orderId" /></th>
													<th><s:property
													value="trainOrderRow.confirmationNumber" /></th>
										<th><s:property
													value="trainOrderRow.confirmationNumber" /> </th>
										<th><s:property
													value="trainOrderRow.statusAction" /></th>
									...
									<s:iterator value="trainTravelRequestQuotationlist" status="serial">
										<tr>
											...
											<s:iterator value="trainOrderRow" >
										<td><s:property value="trainBookingDate"  /></td>
									...
									<s:if test="trainOrderRow!=null" >
									<s:iterator value="trainOrderRow" status="serial">
										<tr>
											<td><s:property value="%{#serial.count}" /></td>
								...
								<table class="table  table-bordered"
                      			 ...
                      			 <table class="table table-bordered" >
									<tr>
									<s:if
										test="%{ReportData.myTrainCreditNote.CreditnoteIssued==false && ReportData.OrderUpdated==true}">
										<th><a
											href="generateTrainCreditNote?id=<s:property value="ReportData.id"/>"
									...
									<s:if
										test="%{ReportData.CreditNoteIssued==true && ReportData.myTrainCreditNote.CreditnoteIssued==true &&  ReportData.creditNoteActiontype=='IssueCreditNote'}">
										<th><a
											href="generateTrainCreditNote?id=<s:property value="ReportData.id"/>"
			...
			<form id="insertTrainOrderModifiedForm" action="insertTrainOrderModifiedInfo" method="post">
				<s:if test="hasActionErrors()">
				...
				<table id="editOrder1" style="border: 2px solid #2283E1;"
						...
						<td><h5>BookingStatus</h5> <input type="hidden"
						  ...
						  <s:else>
							<select name="statusAction" id="statusAction" autocomplete="off"
							 ...
							 <%-- </s:else> --%>
							  <input type="hidden" name="trainOrderRowId"
					...
					<tr>
						...
						<button id="trainSubmit" type="button" class="btn btn-primary" style="width: 78%;">SUBMIT</button>
 ...
 $('#success').click(function() {
	 ...
	 $(document).ready(function(){
		   ...
		   $('#trainSubmit').click(function(){
			   $("#insertTrainOrderModifiedForm").valid();
			   if($("#insertTrainOrderModifiedForm").valid()){
				   document.getElementById("insertTrainOrderModifiedForm").submit();
			   }
		   });
		 		   
		   $("#insertTrainOrderModifiedForm").validate({
