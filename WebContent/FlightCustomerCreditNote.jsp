...
<title>Flight Customer Credit Note</title>
...
<body>
	...
	<div class="content-wrapper">
		...
		<section class="content">
			...
			<div class="in-head" style="border:1px solid black ;color:red">
				...
				<!-- 	<div id="butns" class="clearfix">
						...
						<button type="button"  id="pdf" class="btn btn-primary but no-print">
							Print <i class="fa fa-arrow-circle-right"></i>
						</button>

						<button type="button" id="pdf"
							class="btn btn-primary but no-print">
							PDF <i class="fa fa-arrow-circle-right"></i>
						</button>

						<button type="button" class="btn btn-primary but no-print">
							Mail <i class="fa fa-arrow-circle-right"></i>
						</button>
						<input type="email" name="customerMail" required="required"
							id="mail" style="width: 300px" placeholder="mail"
							class="btn btn-primary but no-print">
          ...
          <div class="lint-invoice-adde text-right">
             <h2>  Lintas Travel Service (M ) SDN BHD</h2>
  	...
  	<s:elseif test="%{creditNoteData.LintasGstOn=='tayyarah'}">
 	<div class="col-xs-4">
	<div class="logo">
            ...
            <b>Email:</b> care@tayyarah.com<b>Website:</b>www.tayyarah.com/</p>
							...
							<div class="col-sm-8">
								<div class="lint-invoice-adde text-right">
									<h2>Lintas Travel Service (M) SDN BHD</h2>
									<p>
										GST Reg.No: 001363410944<br> 2-2 Jalan 1/76D, Desa
										Pandan, 55100 Kuala Lumpur<br> Tel: +603-9207
										488(Hunting) Fax: +603-9287 2323<br> <b>Email:</b>
										inquiries@lintastravel.com <b>Website:</b>www.lintastravel.com
									</p>
								</div>
							</div>
 -->
									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											...
											<s:if test="creditNoteData.agencyAddressList!=null">
												<s:iterator value="creditNoteData.agencyAddressList"
													status="rowCount">
													To: <a href="#"><s:property value="Username"></s:property></a>
													</s:iterator>
 ...
 -->
							...
							<div class="clearfix signature-lint">
 							<div class="col-sm-6 pull-right">
									...
									<s:elseif test="%{creditNoteData.LintasGstOn=='lintas'}">
										<h4>LINTAS TRAVEL SERVICES (M) SDN BHD</h4>
									</s:elseif>
									<s:elseif test="%{creditNoteData.LintasGstOn=='tayyarah'}">
									TAYYARAH.COM
									</s:elseif>
