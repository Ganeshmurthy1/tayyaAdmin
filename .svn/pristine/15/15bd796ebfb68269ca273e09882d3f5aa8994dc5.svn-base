...
public class BusServiceTaxConfig extends Timestampable implements Serializable {
	...
	@Transient
	private BigDecimal carManagementFee;
	...
	public BigDecimal getCarManagementFee() {
		return carManagementFee;
	}
	public void setCarManagementFee(BigDecimal carManagementFee) {
		this.carManagementFee = carManagementFee;
	}
