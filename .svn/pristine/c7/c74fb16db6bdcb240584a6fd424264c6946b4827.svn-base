...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>Marketing Sales Lead Report</h1>
	</section>
	<!-- Main content -->
	<section class="content">
		...
		<div class="row">
			<form  action="AgentSalesLeadCompanyList" method="post" id="filterform">
		<div class="clearfix">
		<div class="col-sm-12">
			<div class="form-group" id="user_form-group" >
 			...
 			<table id="mytable" class="table table-striped"
					...
					<tbody>
						<s:iterator value="companyFilterPage.companyList"  var="companyData" status="rowCount" >

							<tr>
								 <td><s:property value="%{((companyFilterPage.currentPageIndex - 1)*companyFilterPage.maxItems)+#rowCount.count}" /></td>	
								<td>${companyData.salesLeadGeneration.user.username}</td>
								<td >${companyData.salesLeadGeneration.user.email}</td>
