...
public class CommonQuotationDao {
	public static final Logger logger=Logger.getLogger(CommonQuotationDao.class);
	...
	public TripExepense getExpense(Long tripId) {
		...
		try {
			...
			cr.add(Restrictions.eq("tripRequest.id", tripId));
