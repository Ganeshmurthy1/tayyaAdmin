				 ...
				 <div class="flight-admin-details">
                     <h3><span>Train Details:-</span></h3>
								...
								<table class="table table-striped table-bordered"
									...
									<tbody>
 										<tr> 
											 <td><s:property value="trainOrderRow.confirmationNumber"/></td>
												<td><s:property value="trainOrderRow.invoiceNo" /></td>
												<td><s:property value="trainOrderRow.bookingCurrency" /></td>
 												<td><s:property value="trainOrderRow.orderId"/></td>
 												<td><s:property value="trainOrderRow.statusAction" /></td>
												<td><s:property value="trainOrderRow.paidBy" /></td>
												<td><s:property value="trainOrderRow.remarks" /></td>
								...
								<table class="table table-striped table-bordered"
									...
									<tbody>
											  <s:iterator value="trainOrderRow.orderCustomer">
											<tr>
