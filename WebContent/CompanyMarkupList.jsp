...
<div class="content-wrapper">
	...
	<section class="content">
		...
		<div class="row">
			<form action="markupList" method="post" id="filterform">
				<div class="clearfix">
					<div class="col-sm-12">
												 ...
												 --%>
													...
													<%-- <div class="col-sm-2">
														<div class="form-group clearfix">
															...
															<div class="col-sm-12">
																<input type="hidden" id="reportTypeHidden"
																	value="<s:property value="companyFilterPage.companyFilter.companyType"/>">
																<select class="form-control"
																	name="companyFilterPage.companyFilter.companyType"
																	id="reportType" required>
																	<option value="ALL">ALL</option>
																	<s:if
																		test="%{#session.Company.companyRole.isDistributor()}">
																		<option
																			value="<s:text name="global.Wholesaler" ></s:text>"><s:text
				...
				<div class="table-responsive dash-table">
					<table id="mytable" class="table table-striped ddd"
						...
						<tbody>
							<s:iterator value="companyFilterPage.flightMarkupList" status="rowCount"
								var="myobj">
								<tr>
								...
								<s:if test="createdByCompanyName!=null">
									...
									<td><s:if test="#myobj.fixedAmount == 'false'">
  											Percentage 
  											</s:if> <s:if test="#myobj.fixedAmount == 'true'">
  												Fixed  
  											</s:if></td>
									...
									<td>
										<p data-placement="top" title="edit">
											<a
												href="markupProfile?markupId=<s:property value="markupId"/>"
...
<script type="text/javascript">
	function userDelete(id) {
		...
		var finalUrl = newUrl + "deleteMarkupList";
