...
<div class="content-wrapper" ng-app="airDataApp">
	...
	<section class="content-header">
		<h1>
			Dashboard <small>Visa Panel</small> <i class="fa fa-cc-visa"></i>
		</h1>
						...
						<div class="small-box bg-green">
							...
							<div class="small-week small-box-footer">
								 <label class="btn btn-transparent grey-salsa btn-sm "><span style="color: aqua;font-size: 15px" >{{confirmedCount.countD}}</span>&nbsp;&nbsp;&nbsp;
								  <a href="showIndividualVisaReportList?showReportType=BC&filterUptoDate=D"
									...
									<a href="showIndividualVisaReportList?showReportType=BC&filterUptoDate=W"
									...
									<a href="showIndividualVisaReportList?showReportType=BC&filterUptoDate=M"
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading clearfix">
                                    <div class="panel-title-box">
                                     ...
                                     <ul class="panel-controls" style="margin-top: 2px;">
                                     <li><a href="#" ng-click="refreshVisa()" class="panel-refresh"><span class="fa fa-refresh"></span></a></li>
                                            ...
                                            <tbody ng-repeat="name in commonTopFivePojoVisaList">
                                                <tr>
                                                    ...
                                                    <td><span class="label label-danger">{{name.status}}</span></td>
                                                     <td><a href="companyVisaReports" class="btn btn-default btn-blue">see all reports</a></td>
                                                      <td><a href="companyVisaOrders" class="btn btn-default btn-blue">see all Orders </a></td>
                                                </tr> 
                                            </tbody>
                                        </table>
                                    </div>
...
<script>
	...
	app.controller('airDataCtrl',function($scope, $http) {
						...
						$http.get(baseUrl+"getVisaBookingList").then(function(response) {
	...
	app.controller('BookingConfirmCtrl',function($scope, $http) {
		...
		$http.get(baseUrl + "getOnlyVisaOrderJson?bstatus=HK").then(function(response) {
	...
	app.controller('OrderPaymentSuccessCtrl',function($scope, $http) {
		...
		$http.get(baseUrl + "getOnlyVisaOrderJson?pstatus=PS").then(function(response) {
	...
	app.controller('OrderPaymentFailedCtrl',function($scope, $http) {
		...
		$http.get(baseUrl + "getOnlyVisaOrderJson?pstatus=PF").then(function(response) {
	...
	app.controller('OrderChartCtrl', function($scope, $http) {
		var currentUrl = $(location).attr('href');
		var baseUrl = currentUrl.substr(0, currentUrl.lastIndexOf('/') + 1);
		$http.get(baseUrl+"getOnlyVisaOrderJson?bstatus=ALL&type=D").then(function(response) {
		...
		$scope.getWeeklyConfirmed=function(){
			$http.get(baseUrl+"getOnlyVisaOrderJson?bstatus=ALL&type=W").then(function(response) {
				$('.doughnutDefault').hide();
				$('.doughnutDay').hide();
				$('.doughnutWeek').show();
				$('.doughnutMonth').hide();
	  ...
	  $scope.getMonthlyConfirmed=function(){
		   $http.get(baseUrl+"getOnlyVisaOrderJson?bstatus=ALL&type=M").then(function(response) {
			   $('.doughnutDefault').hide();
				$('.doughnutDay').hide();
				$('.doughnutWeek').hide();
				$('.doughnutMonth').show();
