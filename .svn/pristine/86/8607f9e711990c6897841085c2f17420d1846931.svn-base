...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="col-sm-12">
				<h4>
					<a href="companyCarOrders"><span class="pull-right"><i
	...
	<div class="row">
						...
						<div class="box clearfix">
							...
							<div class="modal-body">
								...
								<th>Order Id</th>
									...
									<tr>
										<th><s:property
													value="carOrderRow.orderId" /></th>
													<th><s:property
													value="carOrderRow.confirmationNumber" /></th>
										<th><s:property
													value="carOrderRow.confirmationNumber" /> </th>
										<th><s:property
													value="carOrderRow.statusAction" /></th>
								...
								<table class="table table-bordered"
									...
									<tr>
									<s:if
										test="%{ReportData.myCarCreditNote.CreditnoteIssued==false && ReportData.OrderUpdated==true}">
										<th><a
											href="generateCarCreditNote?id=<s:property value="ReportData.id"/>"
									...
									<s:if
										test="%{ReportData.CreditNoteIssued==true && ReportData.myCarCreditNote.CreditnoteIssued==true &&  ReportData.creditNoteActiontype=='IssueCreditNote'}">
										<th><a
											href="generateCarCreditNote?id=<s:property value="ReportData.id"/>"
			...
			<form action="insertCarOrderModifiedInfo" method="post">
				<s:if test="hasActionErrors()">
						...
						<td><h5>BookingStatus</h5> <input type="hidden"
						  ...
						  <s:else>
							<select name="statusAction" id="statusAction" autocomplete="off"
							 ...
							 <%-- </s:else> --%>
							  <input type="hidden" name="carOrderRowId"
