...
public class ApiProviderFilterAction  extends ActionSupport implements ModelDriven<ApiProviderPage>,SessionAware{
	/**
	 * 
	 */
	...
	public String apiProviderList(){
		...
		HistoryInfo historyInfo = (HistoryInfo) ((sessionMap.get("history")!=null)?sessionMap.get("history"):new HistoryInfo());  
		  historyInfo.changeNature(BrowsingOptionPageEnum.MASTER_CONFIGURATIONS_APIPROVIDER_LIST, BrowsingOptionActionEnum.ACTION_DEFAULT, ActionStatusEnum.SUCCESS); 
