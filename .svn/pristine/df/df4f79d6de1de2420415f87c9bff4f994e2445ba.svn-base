...
public class InsuranceWeeklyAndMonthlyDao {

	public static final Logger logger = Logger.getLogger(InsuranceWeeklyAndMonthlyDao.class);
	
	public Map<String, Integer> getInsuranceWeeklyOrMonthlyReport(User userSessionObj, Company companySessionObj, List<String> userIdList,String reportType) {
		List<InsuranceOrderRow> insuranceOrderRows=new ArrayList<>();
		...
		try {
			...
			if (userSessionObj != null && companySessionObj != null) {
				...
				insuranceOrderRows = criteria.list();
				for (InsuranceOrderRow insuranceOrderRow : insuranceOrderRows) {
					String[] datenTime =insuranceOrderRow.getCreatedAt().toString().split(" ");
	...
	public Long getInsuranceWeeklyOrMonthlyCancellationCount(User userSessionObj, Company companySessionObj, List<String> userIdList,String reportType) {
		List<InsuranceOrderRow> insuranceOrderRows=new ArrayList<>();
		Map<String, Integer> weekMap=new HashMap<>();
		SessionFactory sessionfactory;
		Session session = null;
