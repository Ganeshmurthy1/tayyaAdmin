...
public class BugTrackerFileUpload  extends ActionSupport implements SessionAware,ServletRequestAware{	
	
	private static final long serialVersionUID = 1L;
	public static final org.apache.log4j.Logger logger=org.apache.log4j.Logger.getLogger(BugTrackerFileUpload.class);
			...
			if(ServletActionContext.getRequest() instanceof MultiPartRequestWrapper)
			{
				...
				if(fileParameterNames.hasMoreElements()){
					...
					for (UploadedFile cf : files) {
						...
						//.equals("jpg")||fileType.equals("jpeg") || fileType.equals("gif") || fileType.equals("png")|| fileType.equals("csv") || fileType.equals("xlsx")
						if(fileType!=null){
							if(cf.length()<1024000){
								logger.info("----------Server path:...-------"+servletRequest);
								String file_path = servletRequest.getSession().getServletContext().getRealPath("/bug_tracker");
