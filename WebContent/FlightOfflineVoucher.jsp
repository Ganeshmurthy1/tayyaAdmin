...
<div id="voucherModal" class="modal fade" role="dialog">
  ...
  <textarea class="form-control" rows="2" id="ccEmails"></textarea>
      ...
      <div class="modal-footer">
       ...
       <button type="button"   onclick="sendOfflineVoucherOrInvoiceToMail('voucher','<s:property value="flightOfflineVoucherData.flightOrderRow.orderId"/>');" class="btn btn-primary btn-sm">SEND VOUCHER</button>
...
<!-- Main content -->
        <section class="content">
          ...
          <!-- Small boxes (Stat box) -->
          	...
          	<div class="col-sm-6"> 
          		<a  data-toggle="modal" href="#voucherModal"  class="btn btn-success btn-xs">Send Voucher Via Email</a>
          		<s:if test="%{#session.Company.companyRole.isCorporate() ||#session.Company.companyRole.isSuperUser()}">
          		...
          		<a href="#" class="btn btn-warning btn-xs" onclick="printDiv('display-api-content')">print</a>
          		  <a href='<s:text name="global.resourceApiUrl"></s:text>getpdf/flight?orderids=${flightOfflineVoucherData.flightOrderRow.orderId}' class="btn btn-success btn-xs"   >
															Pdf </a> 
          	</div>
          	<div class="col-sm-6"> 
						<h4  >
		  ...
		  $.ajax({
				...
				success : function(response,textStatus,jqXHR) {
					ApiURL=  response.ApiResourceURL  
					  var formURL = ApiURL+"Email/getHtmlTemplateById?orderid=${flightOfflineVoucherData.flightOrderRow.orderId}&emailType=2";     
					  //var formURL = "http://localhost:8081/LintasTravelAPI//Email/getHtmlTemplateById?orderid=${flightOfflineVoucherData.flightOrderRow.orderId}&emailType=2";     
