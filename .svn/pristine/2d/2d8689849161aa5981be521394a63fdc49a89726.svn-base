...
<body data-ng-controller="AppCtrl">
	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			<h1>Add e-Travel Smart Config</h1>
		</section>
		<!-- Main content -->
		<section class="content">
			...
			<form action="createEtravelSmartConfig" method="post"
				...
				<div class="form-group text-center">
					<div class="col-xs-12 submitWrap text-center">
						<button type="button" class="btn btn-primary btn-lg" id="buttonSubmit">Add e-Travel Smart Config</button>
					</div>
				</div>
			</form>
		</section>
