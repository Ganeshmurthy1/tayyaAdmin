		...
		<section class="content">
			...
			<div class="row">
				...
				<input type="hidden"
					...
					id="user_id">
				<form action="companyCarOrders" method="post" id="filterform">
	...
	<!--xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx newly added filters end xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx -->	
									...
									<div class="col-sm-12">
										...
										<div class="col-sm-6 clearfix cc-all">
											<button type="reset" id="reset" class="btn btn-primary text-right"> 
									...
									<%-- <thead>
									 ...
									 <thead>
										...
										<s:iterator value="commonReportPage.items" status="rowCount">
											<tr>
												<td><s:property value="%{((commonReportPage.currentPageIndex - 1)*commonReportPage.maxItems)+#rowCount.count}" /></td>
