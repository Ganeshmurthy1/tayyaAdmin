...
function createPDF(){
 getCanvas().then(function(canvas){
  ...
  doc = new jsPDF({
        ...
        doc.save('MiscellaneousInvoice.pdf');
...
form.width((a4[0]*1.33333) -80).css('max-width','none');
 ...
 (function(){
	...
	<div class="content-wrapper">
		...
		<h1>Miscellaneous Customer Credit Note</h1>
	</s:if>
	<s:else>
	<h1>Miscellaneous Credit Note</h1>
	 </s:else>
...
<section class="content">
          	...
          	<div class="col-sm-6"> 
          		...
          		<a href='<s:text name="global.resourceApiUrl"></s:text>getpdf/creditnote?orderid=<s:property value="creditNoteData.creditNoteId"/>&travelcode=8' class="btn btn-success btn-xs"   >
															Pdf </a>
          	</div>
          	<div class="col-sm-6">
						<h4 >
					  ...
					  <div class="row">
                    <div class="col-sm-12 clearfix Insurance-offline-vocher">
		  ...
		  $.ajax({
				...
				success : function(response,textStatus,jqXHR) {
					ApiURL=  response.ApiResourceURL  
					 var formURL = ApiURL+"/Email/getHtmlTemplateById?orderid=${creditNoteData.creditNoteId}&emailType=90";  
					// var formURL ="http://localhost:8080/LintasTravelAPI/Email/getHtmlTemplateById?orderid=${creditNoteData.creditNoteId}&emailType=90";
