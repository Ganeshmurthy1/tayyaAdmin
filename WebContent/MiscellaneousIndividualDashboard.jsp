...
<div class="content-wrapper" ng-app="airDataApp">
	...
	<section class="content-header">
		<h1>
			Dashboard <small>Miscellaneous Panel</small> <i class="fa fa-cogs"></i>
		</h1>
					...
					<div class=" col-md-4" ng-controller="BookingConfirmCtrl">
						...
						<div class="small-box bg-green">
							<div class="inner">
								...
								<p>
									Miscellaneous Confirmed Orders(s)
								</p>
							</div>
							<div class="icon">
							...
							<div class="small-week small-box-footer">
								 <label class="btn btn-transparent grey-salsa btn-sm "><span style="color: aqua;font-size: 15px" >{{confirmedCount.countD}}</span>&nbsp;&nbsp;&nbsp;
								  <a href="showIndividualMiscellaneousReportList?showReportType=BC&filterUptoDate=D"
									...
									<a href="showIndividualMiscellaneousReportList?showReportType=BC&filterUptoDate=W"
									...
									<a href="showIndividualMiscellaneousReportList?showReportType=BC&filterUptoDate=M"
					...
					<div class=" col-md-4" ng-controller="OrderPaymentSuccessCtrl">
						...
						<div class="small-box bg-blue">
							<div class="inner">
								...
								<p>Miscellaneous Payment Success</p>
							</div>
							<div class="icon">
							...
							<div class="small-week small-box-footer">
								 ...
								 <a
									href="showIndividualMiscellaneousReportList?showReportType=PS&filterUptoDate=D"
									class="small-box-footer" > Today <i
										class="fa fa-arrow-circle-right"></i></a>
								</label> <label class="btn btn-transparent grey-salsa  btn-sm "><span style="color: aqua;font-size: 15px" >{{successCount.countW}}</span>&nbsp;&nbsp;&nbsp;
									<a href="showIndividualMiscellaneousReportList?showReportType=PS&filterUptoDate=W"
									class="small-box-footer" >Week<i
										class="fa fa-arrow-circle-right"></i></a>
								</label> <label class="btn btn-transparent grey-salsa btn-sm "><span style="color: aqua;font-size: 15px" >{{successCount.countM}}</span>&nbsp;&nbsp;&nbsp;
									<a href="showIndividualMiscellaneousReportList?showReportType=PS&filterUptoDate=M"
									class="small-box-footer" >Month <i
										class="fa fa-arrow-circle-right"></i></a>
								</label>
							</div>
					...
					<div class=" col-md-4" ng-controller="OrderPaymentFailedCtrl">
						...
						<div class="small-box bg-red">
							<div class="inner">
								...
								<p>Miscellaneous Payment Failed</p>
							</div>
							<div class="icon">
							...
							<div class="small-week small-box-footer">
								<label
									class="btn btn-transparent grey-salsa btn-sm "><span style="color: aqua;font-size: 15px" >{{failedCount.countD}}</span>&nbsp;&nbsp;&nbsp;
									 <a href="showIndividualMiscellaneousReportList?showReportType=PF&filterUptoDate=D"
									class="small-box-footer" > Today <i
										class="fa fa-arrow-circle-right"></i></a>
								</label> <label class="btn btn-transparent grey-salsa  btn-sm "> <span style="color: aqua;font-size: 15px" >{{failedCount.countW}}</span>&nbsp;&nbsp;&nbsp;
									<a href="showIndividualMiscellaneousReportList?showReportType=PF&filterUptoDate=W"
									class="small-box-footer" >Week<i
										class="fa fa-arrow-circle-right"></i></a>
								</label> <label class="btn btn-transparent grey-salsa btn-sm "> <span style="color: aqua;font-size: 15px" >{{failedCount.countM}}</span>&nbsp;&nbsp;&nbsp;
									<a href="showIndividualMiscellaneousReportList?showReportType=PF&filterUptoDate=M"
									class="small-box-footer" >Month <i
										class="fa fa-arrow-circle-right"></i></a>
								</label>
							</div>
			 ...
			 <div class="col-sm-12">
                            <div class="panel panel-default">
                                <div class="panel-heading clearfix">
                                    ...
                                    <ul class="panel-controls" style="margin-top: 2px;">
                                     <li><a href="#" ng-click="refreshMisc()" class="panel-refresh"><span class="fa fa-refresh"></span></a></li>
                                            ...
                                            <tbody ng-repeat="name in commonTopFivePojoMiscList">
                                                <tr>
                                                    ...
                                                    <td><span class="label label-danger">{{name.status}}</span></td>
                                                     <td><a href="companyMiscellaneousReports" class="btn btn-default btn-blue">see all reports</a></td>
                                                      <td><a href="companyMiscellaneousOrders" class="btn btn-default btn-blue">see all Orders </a></td>
                                                </tr> 
                                            </tbody>
                                        </table>
                                    </div>
...
<script>
	...
	app.controller('airDataCtrl',function($scope, $http) {
						...
						$http.get(baseUrl+"getMiscellaneousBookingList").then(function(response) {
	...
	app.controller('BookingConfirmCtrl',function($scope, $http) {
		...
		$http.get(baseUrl + "getMiscellaneousAnalysisJson?bstatus=HK").then(function(response) {
	...
	app.controller('OrderPaymentSuccessCtrl',function($scope, $http) {
		...
		$http.get(baseUrl + "getMiscellaneousAnalysisJson?pstatus=PS").then(function(response) {
	...
	app.controller('OrderPaymentFailedCtrl',function($scope, $http) {
		...
		$http.get(baseUrl + "getMiscellaneousAnalysisJson?pstatus=PF").then(function(response) {
	...
	app.controller('OrderChartCtrl', function($scope, $http) {
		var currentUrl = $(location).attr('href');
		var baseUrl = currentUrl.substr(0, currentUrl.lastIndexOf('/') + 1);
		$http.get(baseUrl+"getMiscellaneousAnalysisJson?bstatus=ALL&type=D").then(function(response) {
		...
		$scope.getWeeklyConfirmed=function(){
			$http.get(baseUrl+"getMiscellaneousAnalysisJson?bstatus=ALL&type=W").then(function(response) {
				$('.doughnutDefault').hide();
				$('.doughnutDay').hide();
				$('.doughnutWeek').show();
				$('.doughnutMonth').hide();
	  ...
	  $scope.getMonthlyConfirmed=function(){
		   $http.get(baseUrl+"getMiscellaneousAnalysisJson?bstatus=ALL&type=M").then(function(response) {
			   $('.doughnutDefault').hide();
				$('.doughnutDay').hide();
				$('.doughnutWeek').hide();
				$('.doughnutMonth').show();
