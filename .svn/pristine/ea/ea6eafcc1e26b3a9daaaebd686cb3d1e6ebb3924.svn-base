...
<div>
        ...
        <s:iterator value="CountryList">
         <option value="<s:property value="cur_code" />"><s:property value="cur_code" /></option>
						...
						<div class="col-sm-8">
							...
							<div class="row">
								<div class="col-sm-6 file-upload">
									...
									<input type="file" id="flightExpense.receiptFilename" accept="file_extension|audio/*|video/*|image/*|media_type" ng-file-select="onFileSelect($files)" name="flightExpense.receiptFilename" required > 
								</div>
						...
						<div class="col-xs-12 submitWrap text-center">
								...
								<input type="hidden"  name="expense.trip_id" value="${trip_id}"  id="flightexpensesubmitnew"/>
								<button type="button" id="flightExpenseSubmit" class="btn btn-primary btn-lg">Flight Expanse Save</button>
								
								<!-- <input type="text" autocomplete="off" onclick="return expensesFormSubmit();
															name="flightExpense.department"
															class="form-control input-sm" id="flightdepartment"
															value=""
						...
						<div class="col-sm-8">
							...
							<div class="row">
								<div class="col-sm-6 file-upload">
									...
									<input type="file" id="hotelExpense.receiptFilename" accept="file_extension|audio/*|video/*|image/*|media_type" data-ng-file-select="onFileSelect($files)" name="hotelExpense.receiptFilename" required> 
								</div>
 ...
 --%>
						...
						<div class="col-sm-8">
							...
							<div class="row">
								<div class="col-sm-6 file-upload">
									...
									<input type="file" id="carExpense.receiptFilename" accept="file_extension|audio/*|video/*|image/*|media_type" ng-file-select="onFileSelect($files)" name="carExpense.receiptFilename" required> 
								</div>
						...
						<div class="col-xs-12 submitWrap text-center">
								...
								class="btn btn-primary btn-lg">Car Expanse Save</button> --%> 
								<button type="button"  id="carexpensesubmitnew" 
								class="btn btn-primary btn-lg">Car Expanse Save</button>
								<!-- <input type="text" autocomplete="off"
															name="flightExpense.department"
															class="form-control input-sm" id="flightdepartment"
				...
				<h2>OR</h2>
								 ...
								 <div class="col-sm-4">
													...
													<div class="form-group">
														<label for="remarks" class=" control-label"> Remarks </label> 
														<textarea rows="2" cols="2" class="form-control input-sm" name="trainExpense.remarks" placeholder="remarks" required></textarea>
											...
											<div class="col-sm-4">
												<div class="form-group">
													<label for="hotel address1" class="control-label">From Location</label> <input type="text" autocomplete="off"
														...
														value="${hotelQuotation.hotelAddress}" required>
								...
								<s:iterator value="CountryList">
									<option value="<s:property value="cur_code"/>"><s:property value="cur_code" /></option>
												...
												<div class="col-sm-4">
													...
													<div class="form-group">
														<label for="basePrice" class=" control-label"> Supplier  Price </label> 
														<input type="number" autocomplete="off"
 ...
 --%>
 														<select class="form-control input-sm"
														name="trainExpense.Billable" required>
														<option selected="selected" value="true">YES</option>
														<option value="false">NO</option>
													</select>
												</div>
						...
						<div class="col-sm-8">
							...
							<div class="row">
								<div class="col-sm-6 file-upload">
									...
									<input type="file" id="trainExpense.receiptFilename" accept="file_extension|audio/*|video/*|image/*|media_type" ng-file-select="onFileSelect($files)" name="trainExpense.receiptFilename" required > 
								</div>
						...
						<div class="col-xs-12 submitWrap text-center">
								...
								class="btn btn-primary btn-lg">Train Expanse Save</button> --%> 
								<button type="button" id="trainexpensesubmitnew" 
								class="btn btn-primary btn-lg">Train Expanse Save</button>
								<!-- <input type="text" autocomplete="off"
															name="flightExpense.department"
															class="form-control input-sm" id="flightdepartment"
						...
						<div class="col-sm-8">
							...
							<div class="row">
								<div class="col-sm-6 file-upload">
									...
									<input type="file" id="busExpense.receiptFilename" accept="file_extension|audio/*|video/*|image/*|media_type" ng-file-select="onFileSelect($files)" name="busExpense.receiptFilename" required > 
								</div>
        ...
        <s:iterator value="CountryList">
         <option value="<s:property value="cur_code" />"><s:property value="cur_code" /></option>
						...
						<div class="col-sm-8">
							...
							<div class="row">
								<div class="col-sm-6 file-upload">
									...
									<input type="file" id="mealExpense.receiptFilename" accept="file_extension|audio/*|video/*|image/*|media_type" ng-file-select="onFileSelect($files)" name="mealExpense.receiptFilename" required> 
								</div>
						...
						<div class="col-xs-12 submitWrap text-center">
								...
								class="btn btn-primary btn-lg">Meal Expanse Save</button>  --%>
								<input type="hidden" name="expense.trip_id" value="${trip_id}" />
								<button type="submit"  id="mealexpensesubmitnew" class="btn btn-primary btn-lg">Meal Expanse Save</button> 
								<!-- <input type="text" autocomplete="off"
															name="flightExpense.department"
															class="form-control input-sm" id="flightdepartment"
															value=""
										...
										<div class="col-sm-4">
													...
													<div class="form-group">
														<label for="checkInDate" class=" control-label">WorkName </label> <input type="text" autocomplete="off"
															...
															class="form-control input-sm"
															value="" 
															placeholder="Work Name" required>
        ...
        <s:iterator value="CountryList">
         <option value="<s:property value="cur_code" />"><s:property value="cur_code" /></option>
												...
												<div class="form-group">
													...
													<%-- <select class="form-control input-sm"  name="laborExpense.isBillable" id="laborbillable">
															<option value="" selected="selected">select Billable Type</option>
																...
																<select class="form-control input-sm"
														name="laborExpense.Billable"  required>
														<option selected="selected" value="true">YES</option>
														<option value="false">NO</option>
													</select>
								...
								<div class="col-sm-6 ">
									<div id="fileinfo">
										...
										<div id="filedim">90 x 50</div>
											...
											<div class="col-sm-4">
											 <div class="form-group">
						<label for="uploadimagelabour" class="col-sm-6 control-label">Upload Receipt File
							 </label>
						<div class="col-sm-6">
							...
							<div class="row">
								<div class="col-sm-4 file-upload">
									...
									<input type="file" id="laborExpense.receiptFilename" accept="file_extension|audio/*|video/*|image/*|media_type" ng-file-select="onFileSelect($files)" name="laborExpense.receiptFilename"  required> 
								</div>
						...
						<div class="col-xs-12 submitWrap text-center">
													<input type="hidden" name="expense.trip_id" value="${trip_id}"/>	
														<button type="button" id="laborexpensesubmitnew" 
					...
					class="form-horizontal" name="createVisaExpense" id="createVisaExpense" enctype="multipart/form-data">
						...
						<div class="col-sm-6">
							...
							<div class="row">
								<div class="col-sm-4 file-upload">
									...
									<input type="file" id="visaExpense.receiptFilename" accept="file_extension|audio/*|video/*|image/*|media_type" ng-file-select="onFileSelect($files)" name="visaExpense.receiptFilename" required> 
								</div>
						...
						<div class="col-xs-12 submitWrap text-center">
														<input type="hidden" name="expense.trip_id" value="${trip_id}" />
														<button type="button" id="visaexpensesubmitnew" 
						...
						<div class="col-sm-6">
							...
							<div class="row">
								<div class="col-sm-4 file-upload">
									...
									<input type="file" id="insuranceExpense.receiptFilename" accept="file_extension|audio/*|video/*|image/*|media_type" ng-file-select="onFileSelect($files)" name="insuranceExpense.receiptFilename" required> 
								</div>
				...
				<input type="hidden"  name="expense.trip_id" value="${trip_id}" />										
					...
					class="form-horizontal" name="createMiscellaneousExpense" id="createMiscellaneousExpense" enctype="multipart/form-data">
						...
						<div class="col-sm-8">
							...
							<div class="row">
								<div class="col-sm-6 file-upload">
									...
									<input type="file" id="miscellaneousExpense.receiptFilename" accept="file_extension|audio/*|video/*|image/*|media_type" ng-file-select="onFileSelect($files)" name="miscellaneousExpense.receiptFilename" required> 
								</div>
						...
						<div class="col-xs-12 submitWrap text-center">
													<input type="hidden"  name="expense.trip_id" value="${trip_id}" />	
														<button type="button"  id="miscellaneousexpensesubmitnew" 
...
/* 		 $("#hotelcheckindate").keyup(function () {
	 ...
	 $( "#hotelcheckindate" ).keyIn(function(){
	...
	$(document).ready(function(){
		   ...
		   $('#flightExpenseSubmit').click(function(){
		   ...
		   $("#flightexpensesFormId").validate({
		    ...
		    $("#hotelexpensesFormId").validate({
		     ...
		     $('#carexpensesubmitnew').click(function(){
		   ...
		   $('#laborexpensesubmitnew').click(function(){
			   $("#laborexpensesFormId").valid();
