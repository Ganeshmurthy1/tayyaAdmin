 ...
 <div class="content-wrapper">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
     ...
     <div class="row">
     <div class="col-sm-12"> 
     <input type="hidden" id="visaid"	value="<s:property value="visaOrderRow.orderId"/>">
      <div class="col-sm-6"> 
  ...
  <textarea class="form-control" rows="2" id="invoiceFromEmails"></textarea>
      ...
      <div class="modal-footer">
       <button type="button"   onclick="sendVisaOfflineVoucherOrInvoiceToMail('invoice','<s:property value="visaOrderRow.orderId"/>');" class="btn btn-primary btn-sm">SEND INVOICE</button>
...
<!-- Main content -->
  <section class="content">
          	...
          	<div class="col-sm-6">  
          		...
          		<a href='<s:text name="global.resourceApiUrl"></s:text>getpdf/invoice?orderid=<s:property value="visaOrderRow.orderId"/>&travelcode=6' class="btn btn-success btn-xs"   >
															Pdf </a> 
          	</div>
          	<div class="col-sm-6">
						<h4 >
...
<!-- Main row -->
	...
	function calldataplugin()
	{
		...
		var formURL = ApiURL+"Email/getHtmlTemplateById?orderid="+orderid+"&emailType=66";
      ...
      <script type="text/javascript">
       ...
       function sendVisaOfflineVoucherOrInvoiceToMail(type,orderId) {
        	var toEmails= null;
        	var ccEmails= null;
        	if(type=='voucher'){
          ...
          $.ajax({	
	                url: 'sendVisaOfflineVoucherOrInvoiceToMail',
	                type: 'post',
