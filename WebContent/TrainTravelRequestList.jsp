		...
		<div class="row">
			<form action="superUserCompanyList" method="post" id="filterform">
				<div class="table-responsive dash-table">
					...
					<tbody>
						<s:iterator value="trainTravelRequestlist" status="rowCount">
							<tr>
								 ...
								 <td>
									...
									<div class="dropdown">
									    ...
									    <ul class="dropdown-menu " role="menu" aria-labelledby="menu1">
									      <li role="presentation"><a role="menuitem" tabindex="-1" href="editTrainTravelRequestQuotation?idtosend=<s:property value="id"/>">Edit Quatation</a></li>
									      <li role="presentation"><a role="menuitem" tabindex="-1" href="editTrainOrderRow?idtosend=<s:property value="id"/>">Train order</a></li>  
									      <li role="presentation"><a role="menuitem" tabindex="-1" href="editTrainTravelRequest?idtosend=<s:property value="id"/>">Edit Travel Request</a></li>    
									    </ul>
									    <a href="trainOrderQuotationView?id=<s:property value="id"/>"
