        ...
        <s:iterator value="CountryList">
         <option value="<s:property value="cur_code" />"><s:property value="cur_code" /></option>
						...
						<div class="col-xs-12 submitWrap text-center">
								...
								class="btn btn-primary btn-lg">Flight Expanse Update</button>  --%>
								<input type="hidden"  name="flightExpense.id" value="${id}" />
								<button type="button"  id="updateflightexpenseFormSubmit" 
								class="btn btn-primary btn-lg">Flight Expanse Update</button> 
						...
						<div class="col-sm-8">
							...
							<div class="row">
								<div class="col-sm-6 file-upload">
									...
									<input type="file" id="hotelExpense.receiptFilename" value="${hotelExpense.receiptFilename}" accept="file_extension|audio/*|video/*|image/*|media_type" data-ng-file-select="onFileSelect($files)" name="hotelExpense.receiptFilename" required /> 
								</div>
							...
							<!-- 	ng-file-select="onFileSelect($files)" -->
								...
								<div class="form-group text-center">
						<div class="col-xs-12 submitWrap text-center">
										<input type="hidden" name="hotelExpense.id" value="${id}" />				
														<button type="button" id="updatehotelepenseForm" 
						...
						<div class="col-sm-7">
							...
							<div class="row">
								<div class="col-sm-9 file-upload">
									...
									<input type="file" id="carExpense.receiptFilename" value="${carExpense.receiptFilename}" accept="file_extension|audio/*|video/*|image/*|media_type" ng-file-select="onFileSelect($files)" name="carExpense.receiptFilename" required> 
								</div>
						...
						<div class="col-sm-8">
							...
							<div class="row">
								<div class="col-sm-6 file-upload">
									...
									<input type="file" id="trainExpense.receiptFilename" value="${trainExpense.receiptFilename}" accept="file_extension|audio/*|video/*|image/*|media_type" ng-file-select="onFileSelect($files)" name="trainExpense.receiptFilename"  required> 
								</div>
								 ...
								 <div class="col-sm-6 ">
									<div id="fileinfo">
										...
										<div id="fileError"></div>
											...
											<div class="form-group text-center">
						<div class="col-xs-12 submitWrap text-center">
												<input type="hidden" name="trainExpense.id" value="${id}" />		
														<button type="button" id="updatetrainexpenseForm" 
								 ...
								 <div class="col-sm-6 ">
									<div id="fileinfo">
										...
										<div id="fileError"></div>
												...
												<div class="form-group text-center">
						<div class="col-xs-12 submitWrap text-center">
											<input type="hidden"  name="busExpense.id" value="${id}" />			
														<button type="button" id="updatebusexpenseForm" 
         ...
         <option value="<s:property value="cur_code" />"><s:property value="cur_code" /></option>
						...
						<div class="col-sm-8">
							...
							<div class="row">
								<div class="col-sm-6 file-upload">
									...
									<input type="file" id="mealExpense.receiptFilename" value="${mealExpense.receiptFilename}" accept="file_extension|audio/*|video/*|image/*|media_type" ng-file-select="onFileSelect($files)" name="mealExpense.receiptFilename" required> 
								</div>
						...
						<div class="col-xs-12 submitWrap text-center">
													<input type="hidden"  name="mealExpense.id" value="${id}" />	
														<button type="submit" id="updatemealexpenseForm"
						...
						<div class="col-sm-8">
							...
							<div class="row">
								<div class="col-sm-4 file-upload">
									...
									<input type="file" id="laborExpense.receiptFilename"  value="${laborExpense.receiptFilename}" accept="file_extension|audio/*|video/*|image/*|media_type" ng-file-select="onFileSelect($files)" name="laborExpense.receiptFilename" required> 
								</div>
								 ...
								 <div class="col-sm-4">
									<div id="fileinfo">
										...
										<div id="fileError"></div>
												...
												<div class="form-group text-center">
						<div class="col-xs-12 submitWrap text-center">
												<input type="hidden" name="laborExpense.id" value="${id}">		
														<button type="button"  id="updatelaborexpenseForm" 
								 ...
								 <div class="col-sm-4">
									<div id="fileinfo">
										...
										<div id="fileError"></div>
												...
												<div class="form-group text-center">
						<div class="col-xs-12 submitWrap text-center">
													<input type="hidden" name="visaExpense.id" value="${id}"  />	
														<button type="button"  id="visaexpensesubmitupdate" 
						...
						<div class="col-sm-6">
							...
							<div class="row">
								<div class="col-sm-4 file-upload">
									...
									<input type="file" id="insuranceExpense.receiptFilename" value="${insuranceExpense.receiptFilename}" accept="file_extension|audio/*|video/*|image/*|media_type" ng-file-select="onFileSelect($files)" name="insuranceExpense.receiptFilename" required> 
								</div>
								 ...
								 <div class="col-sm-4">
									<div id="fileinfo">
										...
										<div id="fileError"></div>
												...
												<div class="form-group text-center">
						<div class="col-xs-12 submitWrap text-center">
														<input type="hidden" name="insuranceExpense.id" value="${id}"/>
														<button type="button"  id="insuranceexpensesubmitupdate" 
						...
						<div class="col-sm-6">
							...
							<div class="row">
								<div class="col-sm-6 file-upload">
									...
									<input type="file" id="miscellaneousExpense.receiptFilename" value="${miscellaneousExpense.receiptFilename}" accept="file_extension|audio/*|video/*|image/*|media_type" ng-file-select="onFileSelect($files)" name="miscellaneousExpense.receiptFilename"  required> 
								</div>
	 ...
	 $(function() {
	  ...
	  --%>
		$(document).ready(function(){
			   ...
			   $('#updateflightexpenseFormSubmit').click(function(){
			   ...
			   $('#updatetrainexpenseForm').click(function(){
			   ...
			   $("#trainexpensesFormId").validate({
			    ...
			    $('#updatebusexpenseForm').click(function(){
			   ...
			   $("#laborexpensesFormId").validate({
			     ...
			     $('#visaexpensesubmitupdate').click(function(){
