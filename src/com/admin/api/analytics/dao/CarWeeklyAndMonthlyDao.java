...
public class CarWeeklyAndMonthlyDao {

	public static final Logger logger = Logger.getLogger(CarWeeklyAndMonthlyDao.class);
	
	public Map<String, Integer> getCarWeeklyOrMonthlyReport(User userSessionObj, Company companySessionObj, List<String> userIdList,String reportType) {
		List<CarOrderRow> carOrderRows=new ArrayList<>();
		...
		try {
			...
			if (userSessionObj != null && companySessionObj != null) {
				...
				carOrderRows = criteria.list();
				for (CarOrderRow carOrderRow : carOrderRows) {
					String[] datenTime =carOrderRow.getCreatedAt().toString().split(" ");
	...
	public Long getCarWeeklyOrMonthlyCancellationCount(User userSessionObj, Company companySessionObj, List<String> userIdList,String reportType) {
		List<CarOrderRow> carOrderRows=new ArrayList<>();
		Map<String, Integer> weekMap=new HashMap<>();
		SessionFactory sessionfactory;
		Session session = null;
