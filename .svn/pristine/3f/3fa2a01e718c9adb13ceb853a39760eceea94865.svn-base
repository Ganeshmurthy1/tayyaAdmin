...
public class VisaWeeklyAndMonthlyDao {

	public static final Logger logger = Logger.getLogger(VisaWeeklyAndMonthlyDao.class);
	
	public Map<String, Integer> getVisaWeeklyOrMonthlyReport(User userSessionObj, Company companySessionObj, List<String> userIdList,String reportType) {
		List<VisaOrderRow> visaOrderRows=new ArrayList<>();
		...
		try {
			...
			if (userSessionObj != null && companySessionObj != null) {
				...
				visaOrderRows = criteria.list();
				for (VisaOrderRow visaOrderRow : visaOrderRows) {
					String[] datenTime =visaOrderRow.getCreatedAt().toString().split(" ");
	...
	public Long getVisaWeeklyOrMonthlyCancellationCount(User userSessionObj, Company companySessionObj, List<String> userIdList,String reportType) {
		List<VisaOrderRow> visaOrderRows=new ArrayList<>();
		Map<String, Integer> weekMap=new HashMap<>();
		SessionFactory sessionfactory;
		Session session = null;
