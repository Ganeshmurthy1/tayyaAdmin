				...
				<div class="row">
					...
					<h4 class="text-center">
									...
									<div class="panel-body">
										<form action="updateTrainQuotation" method="post"
					...
					<div class="col-sm-2">
														...
														<label for="trainTravelRequestQuotation.pickUp" class=" control-label">Train
															No </label> <input type="text" autocomplete="off"
															name="trainTravelRequestQuotation.trainNumber"
															class="form-control input-sm" required="required"
															value='<s:property value="trainTravelRequestQuotationlist[0].trainNumber"/>'
													...
													<div class="form-group">
														<label for="trainTravelRequestQuotation.pickUp" class=" control-label">Pick
															Up </label> <input type="text" autocomplete="off"
															name="trainTravelRequestQuotation.Fromlocation"
															class="form-control input-sm" required="required"
															value='<s:property value="trainTravelRequestQuotationlist[0].Fromlocation"/>'
															placeholder="Enter Pickup Location">
													...
													<div class="col-sm-2">
													<div class="form-group">
														<label for="trainTravelRequestQuotation.dropOff" class=" control-label">Drop
															Off </label> <input type="text" autocomplete="off" 
															name="trainTravelRequestQuotation.Tolocation"
															class="form-control input-sm" required="required"
															value='<s:property value="trainTravelRequestQuotationlist[0].Tolocation"/>'
													...
													<div class="col-sm-2">
													<div class="form-group">
														<label for="trainTravelRequestQuotation.currency" class=" control-label">Currency
													...
													<div class="form-group">
														...
														value='<s:property value="trainTravelRequestQuotationlist[0].remarks"/>'
											...
											<div class="form-group text-center">
												...
												<input type="hidden" name="trainTravelRequestQuotation.id"  value="${trainTravelRequestQuotationlist[0].id}">
													<button type="submit" class="btn btn-primary btn-lg" id="buttonSubmit">Update</button>
												</div>
											</div>
