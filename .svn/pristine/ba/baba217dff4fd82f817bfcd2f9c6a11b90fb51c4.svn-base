			...
			<section class="content">
				...
				<div class="row">
					...
					<div class="col-sm-12">
										...
										<form action="updateCarQuotation" method="post"
					...
					<div class="inner-compreg clearfix">
									...
									<div class="col-sm-2">
														<div class="form-group">
															<label for="carTravelRequestQuotation.pickUp"  class="control-label">Pick
																Up </label> <input type="text" autocomplete="off"
																name="carTravelRequestQuotation.pickUp"
																value='<s:property value="carTravelRequestQuotationlist[0].pickUp"/>'
													 ...
													 <div class="col-sm-2">
														<div class="form-group">
															<label for="carTravelRequestQuotation.dropOff" class=" control-label">Drop
																Off </label> <input type="text" autocomplete="off"
																name="carTravelRequestQuotation.dropOff"
																value='<s:property value="carTravelRequestQuotationlist[0].dropOff"/>'
																class="form-control input-sm" required="required"
												 ...
												 <div class="col-sm-2"> 
												<div class="form-group">
													<label for="carTravelRequestQuotation.currency" class=" control-label">Currency
												...
												<div class="col-sm-2"> 
														<div class="form-group">
															...
															<textarea rows="1" cols="1" class="form-control input-sm"
																...
																value='<s:property value="carTravelRequestQuotationlist[0].remarks"/>'
												...
												<div class="form-group text-center">
													<div class="col-xs-12 submitWrap text-center">
														<input type="hidden" name="carTravelRequestQuotation.id"
															value="${carTravelRequestQuotationlist[0].id}">
