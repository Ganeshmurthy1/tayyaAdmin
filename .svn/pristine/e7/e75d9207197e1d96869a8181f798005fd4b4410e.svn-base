...
<div class="content-wrapper">
	...
	<section class="content-header">
			...
			<div class="col-sm-2 clearfix pull-left">
				<h3>Visa Travel Request List(s)</h3>
		...
		<div class="row">
			<form action="superUserCompanyList" method="post" id="filterform">
				<div class="table-responsive dash-table">
					...
					<tbody>
						<s:iterator value="visaTravelRequestlist" status="rowCount">
							<tr>
								 ...
								 <td>
									...
									<div class="dropdown">
									    ...
									    <ul class="dropdown-menu " role="menu" aria-labelledby="menu1">
									      <li role="presentation"><a role="menuitem" tabindex="-1" href="editVisaTravelRequestQuotation?idtosend=<s:property value="id"/>">Edit Visa Quatation</a></li>
									      <li role="presentation"><a role="menuitem" tabindex="-1" href="editVisaOrderRow?idtosend=<s:property value="id"/>"> edit Visa order</a></li>  
									      <li role="presentation"><a role="menuitem" tabindex="-1" href="editVisaTravelRequest?idtosend=<s:property value="id"/>">Edit Travel Request</a></li>    
									    </ul>
									    <a href="visaOrderQuotationView?id=<s:property value="id"/>"
