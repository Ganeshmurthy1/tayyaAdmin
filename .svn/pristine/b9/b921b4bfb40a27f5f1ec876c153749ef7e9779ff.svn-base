...
@Entity
@Table(name = "visa_credit_note")
public class VisaCreditNote implements Serializable{
	...
	public Long getVisaOrderRowId() {
		return visaOrderRowId;
	}
	public void setVisaOrderRowId(Long visaOrderRowId) {
