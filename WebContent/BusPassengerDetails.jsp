				 ...
				 <div class="flight-admin-details">
                     <h3><span>Bus Details:-</span></h3>
								...
								<table class="table table-striped table-bordered"
									...
									<tbody>
 										<tr> 
											 <td><s:property value="busOrderRow.confirmationNumber"/></td>
 												<td><s:property value="busOrderRow.busCompanyName" /></td>
												<td><s:property value="busOrderRow.invoiceNo" /></td>
												<td><s:property value="busOrderRow.bookingCurrency" /></td>
 												<td><s:property value="busOrderRow.orderId"/></td>
 												<td><s:property value="busOrderRow.statusAction" /></td>
												<td><s:property value="busOrderRow.paidBy" /></td>
												<td><s:property value="busOrderRow.remarks" /></td>
								...
								<table class="table table-striped table-bordered"
									...
									<tbody>
											  <s:iterator value="busOrderRow.orderCustomer">
											<tr>
