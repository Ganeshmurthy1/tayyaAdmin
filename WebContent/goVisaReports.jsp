...
<body>
		...
		<section class="content">
			...
			<div class="row">
				...
				<s:if test="%{#session.Company!=null && #session.User!=null}">
					...
					<form action="companyVisaReports" method="post" id="filterform">
									...
									<div class="panel-body">
										...
										<div class=" filter-text col-sm-12 clearfix">
											<div class="row">
												...
												<s:if
													test="%{(#session.Company.companyRole.isSuperUser()==true) || #session.Company.companyRole.isDistributor() || #session.Company.companyRole.isAgent()}">
													<div class="col-sm-2">
														<div class="form-group clearfix">
												...
												<div class="col-sm-2">
													...
													<!--xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx newly added filters xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx -->										
												<div class="col-sm-2">
													<div class="form-group clearfix">
														<label class="col-sm-12 control-label"> Invoice No</label>
														<div class="col-sm-12">
															<input type="text" autocomplete="on" class="form-control"
																id="cInvoiceNo" placeholder="Invoice No"
																name="commonReportPage.flightReportFilter.invoiceNo"
																>
														</div>
													</div>
												</div>
												...
												<div class="col-sm-2">
													<div class="form-group clearfix">
														...
														<div class="col-sm-12">
															<input type="text" autocomplete="on" class="form-control"
																id="cfirstName" placeholder="customer first Name"
																name="commonReportPage.flightReportFilter.firstName"
																>
														</div>
													</div>
												</div>
												<div class="col-sm-2">
													<div class="form-group clearfix">
														...
														<div class="col-sm-12">
															<input type="text" autocomplete="on" class="form-control"
																id="clastName" placeholder="customer last Name"
																name="commonReportPage.flightReportFilter.lastName"
																>
														</div>
													</div>
												</div>
													...
													<div class="form-group clearfix">
														...
														<div class="col-sm-12">
															<%-- <input type="text" autocomplete="on" class="form-control"
																...
																value="<s:property value="commonReportPage.flightReportFilter.SupplierName"/>"> --%>
																<select class="form-control input-sm" name="commonReportPage.flightReportFilter.SupplierName"
														id="SupplierName" >
												...
												<div class="col-sm-2">
													<div class="form-group clearfix">
														<label class="col-sm-12 control-label">Customer Mobile</label>
														<div class="col-sm-12">
															<input type="text" autocomplete="on" class="form-control"
																id="CustomerMobile" placeholder="Customer Mobile"
																name="commonReportPage.flightReportFilter.customerMobileNo"
																>
														</div>
													</div>
												</div>
												<!-- <div class="col-sm-2">
													<div class="form-group clearfix">
														...
														<div class="col-sm-12">
															<input type="text" autocomplete="on" class="form-control"
																id="Locationfrm" placeholder="Location"
																name="commonReportPage.flightReportFilter.location"
																>
														</div>
													</div>
												</div> -->
												...
												<div class="col-sm-2">
													<div class="form-group clearfix">
														<label class="col-sm-12 control-label">Country/Location</label>
														<select class="form-control input-sm" name="commonReportPage.flightReportFilter.location" id="Countryname"	>
														<option >ALL</option>
							           					<s:iterator  value="CountryList">
															<s:if test="commonReportPage.flightReportFilter.location != null && commonReportPage.flightReportFilter.location == c_code">
																<option selected="selected"><s:property value="c_code"></s:property></option>
															</s:if>
															<s:else>
																<option ><s:property value="c_code"></s:property></option>
															</s:else>	
														</s:iterator>
															</select>
													</div>
	...
	<!--xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx newly added filters end xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx -->
									...
									<table id="example" class="table table-striped table-bordered"
										...
										<tbody>
											<s:iterator value="commonReportPage.items" status="rowCount">
												...
												<td><s:property value="vfsTaxes" />
												<td><s:property value="courierCharges" />
	...
	<script>
		$(document).ready(function() {
			...
			$("#invoiceDate1").keyup(function() {
				$(this).next("#invoiceDate2").focus();
			});
			...
			$('#invoiceDate1').datepicker({
				...
				changeYear : true,
				onSelect : function(selectedDate) {
					var date2 = $("#invoiceDate1").datepicker('getDate', '+1d');
					date2.setDate(date2.getDate() + 1);
					$("#invoiceDate2").datepicker('setDate', date2);
					$("#invoiceDate2").datepicker("option", "minDate", date2);
				},
				onClose : function() {
					$("#invoiceDate2").focus();
				}
			...
			$('#invoiceDate2').datepicker({
				...
				onSelect : function(selectedDate, i) {
					// $("#fromDate").datepicker("option", selected)
					var date2 = $("#invoiceDate2").datepicker('getDate', '+1d');
				}
