...
<body class="container" data-ng-controller="AppCtrl">
							 				...
							 				<div class="col-sm-4">
													...
													<div class="form-group">
														...
														<input type="text" autocomplete="off"
															...
															value="" required
															placeholder="Enter Confirmation Number" maxlength="30">
												...
												<div class="col-sm-4">
													...
													<div class="form-group">
														...
														<input type="text" autocomplete="off"
															...
															value="" required
															placeholder="Enter Passenger Name" maxlength="100">
												...
												<div class="col-sm-4">
													...
													<div class="form-group">
														...
														<input type="number" autocomplete="off"
															...
															class="form-control input-sm" maxlength="30" id="supplierPrice"
															value="" required
												...
												<div class="col-sm-4">
													...
													<div class="form-group">
														...
														<input type="number" autocomplete="off"
															...
															value="" required
															placeholder="Enter Base Price" maxlength="30">
												...
												<div class="col-sm-4">
													...
													<div class="form-group">
														...
														<input type="number" autocomplete="off"
															...
															value="" required
															placeholder="Enter Other Taxes " maxlength="30">
												...
												<div class="col-sm-4">
													...
													<div class="form-group">
														...
														<input type="number" autocomplete="off"
															...
															value="" required
															placeholder="Enter toll/park charges" maxlength="30">
												...
												<div class="col-sm-4">
													...
													<div class="form-group">
														...
														<input type="number" autocomplete="off"
															...
															value="" required
															placeholder="Enter Driver Allowance Day" maxlength="30">
												...
												<div class="col-sm-4">
													...
													<div class="form-group">
														...
														<input type="number" autocomplete="off"
															...
															value="" required
															placeholder="Enter Driver Allowance Night" maxlength="30">
												...
												<div class="col-sm-4">
													...
													<div class="form-group">
														...
														<input type="number" autocomplete="off"
															...
															value="" required
															placeholder="Enter Management Fee" maxlength="30">
												...
												<div class="col-sm-4">
													...
													<div class="form-group">
														...
														<input type="number" autocomplete="off"
															...
															value="" required
															placeholder="Enter Convenience Fee" maxlength="30">
												...
												<div class="col-sm-4">
													...
													<div class="form-group">
														...
														<input type="text" autocomplete="off"
															...
															value="" required
															placeholder="Enter extraKM" maxlength="30">
												...
												<div class="col-sm-4">
													...
													<div class="form-group">
														...
														<input type="text" autocomplete="off"
															...
															value="" required
															placeholder="Enter Extra Hours" maxlength="30">
													...
													<div class="form-group">
														...
														<input type="text" autocomplete="off"
															...
															value="" 
															placeholder="Car Company name" maxlength="100" required>
												...
												<div class="col-sm-4">
													...
													<div class="form-group">
														...
														<input type="text" autocomplete="off"
															...
															value="" 
															placeholder="Location " maxlength="100" required>
													...
													<div class="form-group">
														<label for="checkInDate" class=" control-label">PickUp </label>
														 <input type="text" autocomplete="off"
															...
															value="" 
															placeholder="PickUp Location " maxlength="100" required>
												...
												<div class="col-sm-4">
													...
													<div class="form-group">
														...
														<input type="text" autocomplete="off"
															...
															value="" 
															placeholder="DropOff Location " maxlength="100" required>
 ...
 --%>
						...
						<div class="col-xs-12 submitWrap text-center">
														...
														<button type="button"  name="expense.trip_id" value="${trip_id}"  id="carexpensesubmitnew" 
