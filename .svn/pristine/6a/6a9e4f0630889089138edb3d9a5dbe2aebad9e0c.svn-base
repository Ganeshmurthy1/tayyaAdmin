	...
	<div>
		<div id="mypdf">
			...
			<section class="content">
				<c:if test="${carTravelRequest!=null}">
					<div class="row">
						<div class="col-sm-12">
							<h4>Car Travel Request Details</h4>
						</div>
					</div>
					<div class="row">
						<!-- edit form column -->
						...
						<div class="p-info clearfix">
							...
							<div class="p-inp">
								<p>${carTravelRequest.travelDate}</p>
							</div>
						</div> --%>
									</div>
									<%-- <div class="col-sm-6 ">
				...
				<s:if
					test="carTravelRequestQuotationlist!=null && carTravelRequestQuotationlist.size()>0">
					<div class="row">
											...
											<tbody>
												...
												<c:forEach items="${carTravelRequestQuotationlist}"
													...
													<tr>
														...
														<td>${carTravelRequestQuotation.carOrderRow.bookingCurrency} ${carTravelRequestQuotation.carOrderRow.totalAmount}</td>
														<td>
