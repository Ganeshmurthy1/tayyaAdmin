		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="row">
					...
					<h3 style="font-size: 20px;margin: 0px;"><i class="fa fa-file" aria-hidden="true"></i> InsuranceOrderRow</h3>  
					</div>
...
<%-- 					<div class="col-sm-9 clearfix pull-right " data-placement="top">
			...
			<section class="content">
				...
				<div class="row">
					...
					<div class="col-sm-12">
					<form action="updateInsuranceOrder" method="post"
				...
				<div class="companysetup clearfix"> 
					...
					<div class="inner-compreg clearfix">  
												<div class="col-sm-2">
													<div class="form-group">
														<label for="insuranceOrderRow.confirmationNumber"
															...
															value='<s:property value="insuranceOrderRow.confirmationNumber"/>'  
												...
												<div class="col-sm-2">
													<div class="form-group">
														<label for="insuranceOrderRow.travelDateTemp" class=" control-label">Travel
															Date </label> <input type="text" autocomplete="off"
															name="insuranceOrderRow.travelDateTemp" onchange="validateDateFormat(this)"
															class="form-control input-sm" id="traveldateforcar"
															value='<s:property value="insuranceOrderRow.travelDateTemp"/>'   placeholder="Enter Travel Date ">
													</div>
												</div>
												<div class="col-sm-2">
													<div class="form-group">
														<label for="insuranceOrderRow.travelDateTemp" class=" control-label">remarks
															</label> <input type="text" autocomplete="off"
															name="insuranceOrderRow.remarks" onchange="validateDateFormat(this)"
															class="form-control input-sm" id="traveldateforcar"
															value='<s:property value="insuranceOrderRow.remarks"/>'   placeholder="Enter remarks ">
													</div>
												</div>
												<div class="col-sm-2">
													<div class="form-group">
														<label for="insuranceOrderRow.travelDateTemp" class=" control-label">country Of Travel
															</label> <input type="text" autocomplete="off"
															name="insuranceOrderRow.countryOfTravel" onchange="validateDateFormat(this)"
															class="form-control input-sm" id="traveldateforcar"
															value='<s:property value="insuranceOrderRow.countryOfTravel"/>'   placeholder="Enter countryOfTravel ">
													</div>
												</div>
												<div class="col-sm-2">
													<div class="form-group">
														<label for="insuranceOrderRow.travelDateTemp" class=" control-label">supplierName 
														    </label> <input type="text" autocomplete="off"
															name="insuranceOrderRow.supplierName" onchange="validateDateFormat(this)"
															class="form-control input-sm" id="traveldateforcar"
															value='<s:property value="insuranceOrderRow.supplierName"/>'   placeholder="Enter supplierName ">
													</div>
												</div>
					...
					<div class="inner-compreg clearfix">
											 ...
											 <div class="col-sm-2">
													<div class="form-group">
														<label for="insuranceOrderRow.travelDateTemp" class=" control-label">supplierPrice
															</label> <input type="text" autocomplete="off"
															name="insuranceOrderRow.supplierPrice" onchange="validateDateFormat(this)"
															class="form-control input-sm" id="traveldateforcar"
															value='<s:property value="insuranceOrderRow.supplierPrice"/>'   placeholder="Enter supplierPrice ">
													</div>
													</div>
													<div class="col-sm-2">
													...
													<div class="form-group">
														<label for="insuranceOrderRow.managementFee"
															...
															class="form-control input-sm" id="managementFee" value='<s:property value="insuranceOrderRow.managementFee"/>'
													...
													<div class="form-group">
														<label for="convenienceFee" class=" control-label">
															...
															name="insuranceOrderRow.convenienceFee" onchange="numbersonly(this)"
															class="form-control input-sm" id="convenienceFee"
															value='<s:property value="insuranceOrderRow.convenienceFee"/>'   placeholder="Enter Convenience Fee">
													...
													<div class="form-group">
														<label for="serviceTax" class=" control-label">
															...
															name="insuranceOrderRow.serviceTax" onchange="numbersonly(this)"
															class="form-control input-sm" id="serviceTax" value='<s:property value="insuranceOrderRow.serviceTax"/>'
													...
													<div class="form-group">
														<label for="insuranceOrderRow.otherTaxes" class=" control-label">
															Other Taxes </label> <input type="text" autocomplete="off"
															name="insuranceOrderRow.otherTaxes" onchange="numbersonly(this)"
															class="form-control input-sm" id="otherTaxes" value='<s:property value="insuranceOrderRow.otherTaxes"/>'
													...
													<div class="form-group">
														<label for="insuranceOrderRow.basePrice" class=" control-label">
															Base Price </label> <input type="text" autocomplete="off"
															name="insuranceOrderRow.basePrice" onchange="numbersonly(this)"
															class="form-control input-sm" id="basePrice" value='<s:property value="insuranceOrderRow.basePrice"/>'
													...
													<div class="form-group">
														<label for="insuranceOrderRow.totalAmount"
															...
															type="text" autocomplete="off" onchange="numbersonly(this)"
															name="insuranceOrderRow.totalAmount" id="carexpenseamount"
															class="form-control input-sm" placeholder="Total Amount"
															value='<s:property value="insuranceOrderRow.totalAmount"/>'  >
											...
											<div class="form-group text-center">
												...
												<input type="hidden" name="insuranceOrderRow.id"  value="${insuranceOrderRow.id}">
													<button type="submit" name="carTravelRequest" value=""
														id="carTravelRequestsubmitnew"
														class="btn btn-primary btn-lg">insurance quotation update
														</button>
												</div>
											</div>
