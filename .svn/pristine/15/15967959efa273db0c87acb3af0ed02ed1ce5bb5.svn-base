		...
		<section class="content">
			...
			<div class="row">
				...
				<s:if test="%{#session.Company!=null && #session.User!=null}">
					...
					<form action="companyBusReports" method="post" id="filterform">
													...
													<div class="form-group clearfix">
														...
														<div class="col-sm-12">
															<input type="text" autocomplete="off"
																class="form-control" id="confirmationNo"
									...
									<table id="example" class="table table-striped table-bordered"
										...
										<thead>
											<tr>
												...
												<th>Travel Date</th>
												<s:if
													test="%{#session.User.userrole_id.isSuperuser()}">
											...
											<s:iterator value="commonReportPage.items" status="rowCount">
												<tr>
													...
													<s:if
														...
														<%-- <s:if
														test="%{#session.User.userrole_id.isSuperuser()||#session.Company.companyRole.isDistributor() || #session.Company.companyRole.isAgent()}">
														<td><s:property value="%{bookingPrice+gstTax}" /></td>
													</s:if>
													<s:else>
