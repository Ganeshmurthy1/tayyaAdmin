...
<!-- 
						...
						<div class="commonone clearfix">
							<div class="form-group clearfix">
								<label class="control-label">Amount (${paymentTransaction.currency})</label> <input type="text"
									class="form-control amountValid cusValidationforprice required"   id="payBalance"  value="${paymentTransaction.balance}"  placeholder="Amount" required="required"
						...
						<div class="clearfix client-comments"   style="display: none">
							<div class="form-group clearfix">
								...
								<textarea rows="2" cols="2" class="form-control" style="width: 93%;" required 
