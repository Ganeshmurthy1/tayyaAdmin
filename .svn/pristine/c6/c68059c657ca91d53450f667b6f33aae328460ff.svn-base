...
public class BusWeeklyAndMonthlyDao {

	public static final Logger logger = Logger.getLogger(BusWeeklyAndMonthlyDao.class);
	
	public Map<String, Integer> getBusWeeklyOrMonthlyReport(User userSessionObj, Company companySessionObj, List<String> userIdList,String reportType) {
		List<BusOrderRow> busOrderRows=new ArrayList<>();
		...
		try {
			...
			if (userSessionObj != null && companySessionObj != null) {
				...
				busOrderRows = criteria.list();
				for (BusOrderRow busOrderRow : busOrderRows) {
					String[] datenTime =busOrderRow.getCreatedAt().toString().split(" ");
	...
	public Long getBusWeeklyOrMonthlyCancellationCount(User userSessionObj, Company companySessionObj, List<String> userIdList,String reportType) {
		List<BusOrderRow> busOrderRows=new ArrayList<>();
		Map<String, Integer> weekMap=new HashMap<>();
		SessionFactory sessionfactory;
		Session session = null;
