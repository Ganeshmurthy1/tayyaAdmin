...
<body data-ng-controller="AppCtrl">
	...
	<div class="content-wrapper">
		...
		<section class="content">
			...
			<form action="createBluestarConfig" id="createBluestarConf" method="post"
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control input-sm" id="title"
							name="title" placeholder="user Name" autocomplete="off"
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control input-sm" id="hostUrl"
							name="hostUrl" placeholder="host Url" autocomplete="off"
							  required>
					</div>
				</div>
				...
				<div class="form-group text-center">
					<div class="col-xs-12 submitWrap text-center">
						<button id="ConfigAdd" type="button" class="btn btn-primary btn-lg">Add</button>
					</div>
				</div>
			</form>
		</section>
...
$(document).ready(function(){
	   ...
	   $('#ConfigAdd').click(function(){
		   $("#createBluestarConf").valid();
		   if($("#createBluestarConf").valid()){
			   document.getElementById("createBluestarConf").submit();
		   }
	   });
	   $("#createBluestarConf").validate({
