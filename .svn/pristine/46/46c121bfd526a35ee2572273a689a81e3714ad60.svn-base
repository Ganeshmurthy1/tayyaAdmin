...
<%-- <script
	...
	<script src="js/agent_invoice.js"> </script>
...
<body>
	<div class="content-wrapper">
		...
		<s:if test="invoiceType==0">
			<h1>My Hotel Invoice List</h1>
			</s:if>
			<s:else>
			<h1>Hotel Agent Invoice List</h1>
			 </s:else>
		...
		<section class="content">
			...
			<div class="row">
				...
				<s:if test="invoiceType==0">
						<form action="hotelMyCommInvoiceList" method="post" id="filterform">
						</s:if>
						<s:else>
					<form action="hotelAgentCommInvoiceList" method="post" id="filterform">
					</s:else>
				 <div class="col-sm-12">
							...
							<div class="box clearfix">
								...
								<table id="example" class="table table-striped table-bordered"
									...
									<tbody>
										...
										<s:iterator value="flightInvoicePage.hotelItems"
											status="rowCount">
											<tr>
												...
												<td>
													<p data-placement="top" title="Generate Invoice">
														...
														<a
															href="generateHotelAgentCommissionInvoice?invoiceType=${invoiceType}&id=<s:property value="id"/>&orderReference=<s:property value="orderReference"/>&userId=<s:property value="userId"/>"
