 ...
 <div class="content-wrapper">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
     ...
     <div class="row">
     <div class="col-sm-12"> 
     <input type="hidden" id="visaid"	value="<s:property value="miscellaneousOrderRow.orderId"/>">
      <div class="col-sm-6"> 
  ...
  <textarea class="form-control" rows="2" id="invoiceFromEmails"></textarea>
      ...
      <div class="modal-footer">
       <button type="button"   onclick="sendMiscellaneousOfflineVoucherOrInvoiceToMail('invoice','<s:property value="miscellaneousOrderRow.orderId"/>');" class="btn btn-primary btn-sm">SEND INVOICE</button>
...
<!-- Main content -->
  <section class="content">
          	...
          	<div class="col-sm-6">  
          		...
          		<a href='<s:text name="global.resourceApiUrl"></s:text>getpdf/invoice?orderid=<s:property value="miscellaneousOrderRow.orderId"/>&travelcode=8' class="btn btn-success btn-xs"   >
															Pdf </a> 
          	</div>
          	<div class="col-sm-6">
						<h4 >
...
<!-- Main row -->
	...
	function calldataplugin()
	{
		...
		var orderid = $("#visaid").val();
		var formURL = ApiURL+"Email/getHtmlTemplateById?orderid="+orderid+"&emailType=69";
		//var formURL = "http://localhost:8080/LintasTravelAPI/Email/getHtmlTemplateById?orderid="+orderid+"&emailType=69";
      ...
      <script type="text/javascript">
       ...
       function sendMiscellaneousOfflineVoucherOrInvoiceToMail(type,orderId) {
        	var toEmails= null;
        	var ccEmails= null;
        	if(type=='voucher'){
          ...
          $.ajax({	
	                url: 'sendMiscellaneousOfflineVoucherOrInvoiceToMail',
	                type: 'post',
