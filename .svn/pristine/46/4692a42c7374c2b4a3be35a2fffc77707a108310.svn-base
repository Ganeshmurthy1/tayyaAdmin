...
<body data-ng-controller="AppCtrl">
					...
					<div class="col-sm-8">
					 <div class="form-group">
 						...
 						<div class="form-group">
								...
								<div class="col-sm-8">
									<input class="form-control input-sm" type="text" name="companyGstIn" required
 ...
 --%>
					...
					<div class="form-group" >
						...
						<input   type="text"  class="form-control input-sm" id="sales_person_name" required
				...
				<div class="border-common">
						<p class="h4">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input class="form-control input-sm" type="url" name="Website" required
 ...
 --%>
							...
							<div class="form-group">
								<label for="Company" class="col-sm-2 control-label">Company</label>
								<div class="col-sm-8">
									<input type="text" class="form-control input-sm" id="companyBilling"
										name="Billingcompany"
...
<%-- 
							...
							<div class="form-group">
								<label for="Address" class="col-sm-2 control-label">Address</label>
								<div class="col-sm-8">
									<textarea class="form-control input-sm" id="addressBilling"
							...
							<div class="form-group">
								...
								<div class="col-md-8 text-right">
									<input class="btn btn-primary" id="buttonSubmit" value="Save Changes"
										type="button">
