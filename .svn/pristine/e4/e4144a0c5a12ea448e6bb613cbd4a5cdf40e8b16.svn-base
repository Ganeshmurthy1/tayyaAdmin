...
<div class="content-wrapper">
	...
	<section class="content">
		...
		<div class="adminfree-cancelation pull-right ">
                  <a href="#"><span><i class="fa fa-info-circle fa-4x"></i></span>
                    <div class="adminfree-cancelhover">
                      <span class="adminarrow right pull-up arrow-primary"></span>
                        <div>
                          <h4><span>Level 1:</span></h4>
                          <p>Company Approval</p>
                        </div>
                        <div>
                          <h4><span>Level 2:</span></h4>
                          <p>Set Company Configuration</p>
                        </div>
                    </div>
                  </a>
              </div>
	 ...
	 --%>
		...
		<form action="getApprovalCompaniesList" method="post">
		...
		<div class="col-sm-12">
			<div class="form-group" id="user_form-group" >
				...
				<div class="add-new">
						<a class="btn btn-primary but btn-clean" href="getNonApprovalCompaniesList">
							New Companies <i class="fa fa-angle-right"></i>
						</a>
					</div>
				</div>
						</div>
								...
								<td>
								 ...
								 <c:choose>
										...
										<%--   <input type="button" class="btn-primary" value="Approve" onclick="activateOrDeactivateFormsubmit(<s:property value="companyid"/>)"	id="stat<s:property value="companyid"/>">  --%>
											...
											<p data-placement="top" >
											 <a href="compnayApproval?companyid=<s:property value="companyid"/>&Status=<s:property value="Status"/>"
											class="btn btn-success btn-xs" data-toggle="modal" style="pointer-events:none;cursor:default;border-color: #c2c5c3;background-color: #c2c5c3;">Approve</a>
 									 		</p>
											...
											<p data-placement="top" >
											 <a href="compnayApproval?companyid=<s:property value="companyid"/>&Status=<s:property value="Status"/>"
											class="btn btn-success btn-xs" data-toggle="modal" style="pointer-events:none;cursor: default;border-color: #d50000;background-color:#d50000;">Approve</a>
 									 		</p>
