						...
						<div class="col-sm-6">
							...
							<div class="row">
								<div class="col-sm-4 file-upload">
									...
									<input type="file" id="laborExpense.receiptFilename" accept="file_extension|audio/*|video/*|image/*|media_type" ng-file-select="onFileSelect($files)" name="laborExpense.receiptFilename"  > 
								</div>
