...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="col-sm-12">
				<h4>
					<a href="companyInsuranceReports"><span class="pull-right"><i
	...
	<div class="row">
						...
						<div class="box clearfix">
							...
							<div class="modal-body">
								...
								<th>Order Id</th>
									...
									<tr>
										<th><s:property
													value="insuranceOrderRow.orderId" /></th>
													<th><s:property
													value="insuranceOrderRow.confirmationNumber" /></th>
										<th><s:property
													value="insuranceOrderRow.confirmationNumber" /> </th>
										<th><s:property
													value="insuranceOrderRow.statusAction" /></th>
									...
									<s:if test="insuranceTravelRequestQuotationlist!=null && insuranceTravelRequestQuotationlist.size>0">
									<s:iterator value="insuranceTravelRequestQuotationlist" status="serial">
										<tr>

											<td><s:property value="%{#serial.count}" /></td>
											<s:iterator value="insuranceOrderRow" >
									...
									<s:if test="insuranceOrderRow!=null" >
									<s:iterator value="insuranceOrderRow" status="serial">
										<tr>
											<td><s:property value="%{#serial.count}" /></td>
								...
								<table class="table  table-bordered"
									...
									<tr>
									<s:if
										test="%{ReportData.myInsuranceCreditNote.CreditnoteIssued==false && ReportData.OrderUpdated==true}">
										<th><a
											href="generateInsuranceCreditNote?id=<s:property value="ReportData.id"/>"
									...
									<s:if
										test="%{ReportData.CreditNoteIssued==true && ReportData.myInsuranceCreditNote.CreditnoteIssued==true &&  ReportData.creditNoteActiontype=='IssueCreditNote'}">
										<th><a
											href="generateInsuranceCreditNote?id=<s:property value="ReportData.id"/>"
			...
			<form id="insertInsuranceOrderModifiedForm" action="insertInsuranceOrderModifiedInfo" method="post">
				<s:if test="hasActionErrors()">
				...
				<table id="editOrder1" style="border: 2px solid #2283E1;"
						...
						<td><h5>BookingStatus</h5> <input type="hidden"
						  ...
						  <s:else>
							<select name="statusAction" id="statusAction" autocomplete="off"
							 ...
							 <%-- </s:else> --%>
							  <input type="hidden" name="insuranceOrderRowId"
					...
					<tr>
						...
						<button id="insertSubmit" type="button" class="btn btn-primary" style="width: 78%;">SUBMIT</button>
 ...
 $('#success').click(function() {
	...
	$(document).ready(function(){
		   ...
		   $('#insertSubmit').click(function(){
			   $("#insertInsuranceOrderModifiedForm").valid();
			   if($("#insertInsuranceOrderModifiedForm").valid()){
				   document.getElementById("insertInsuranceOrderModifiedForm").submit();
			   }
		   });
		 		   
		   $("#insertInsuranceOrderModifiedForm").validate({
