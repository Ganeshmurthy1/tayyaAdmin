...
<div class="content-wrapper" ng-app="airDataApp">
	...
	<section class="content-header">
		<h1>
			Dashboard <small>Train Panel</small> <i class="fa fa-train"></i>
		</h1>
						...
						<div class="small-box bg-green">
							...
							<div class="small-week small-box-footer">
								 <label class="btn btn-transparent grey-salsa btn-sm "><span style="color: aqua;font-size: 15px" >{{confirmedCount.countD}}</span>&nbsp;&nbsp;&nbsp;
								  <a href="showIndividualTrainReportList?showReportType=BC&filterUptoDate=D"
									...
									<a href="showIndividualTrainReportList?showReportType=BC&filterUptoDate=W"
									...
									<a href="showIndividualTrainReportList?showReportType=BC&filterUptoDate=M"
			 ...
			 <div class="col-sm-12">
                            <div class="panel panel-default">
                                <div class="panel-heading clearfix">
                                   ...
                                   <ul class="panel-controls" style="margin-top: 2px;">
                                     <li><a href="#" ng-click="refreshTrain()" class="panel-refresh"><span class="fa fa-refresh"></span></a></li>
                                            ...
                                            <tbody ng-repeat="name in commonTopFivePojoTrainList">
                                                <tr>
                                                    ...
                                                    <td><span class="label label-danger">{{name.status}}</span></td>
                                                     <td><a href="companyTrainReports" class="btn btn-default btn-blue">see all reports</a></td>
                                                      <td><a href="companyTrainOrders" class="btn btn-default btn-blue">see all Orders </a></td>
                                                </tr> 
                                            </tbody>
                                        </table>
                                    </div>
...
<script>
	...
	app.controller('airDataCtrl',function($scope, $http) {
						...
						$http.get(baseUrl+"getTrainBookingList").then(function(response) {
	...
	app.controller('BookingConfirmCtrl',function($scope, $http) {
		...
		$http.get(baseUrl + "getTrainAnalysisJson?bstatus=HK").then(function(response) {
	...
	app.controller('OrderPaymentSuccessCtrl',function($scope, $http) {
		...
		$http.get(baseUrl + "getTrainAnalysisJson?pstatus=PS").then(function(response) {
	...
	app.controller('OrderPaymentFailedCtrl',function($scope, $http) {
		...
		$http.get(baseUrl + "getTrainAnalysisJson?pstatus=PF").then(function(response) {
	...
	app.controller('OrderChartCtrl', function($scope, $http) {
		var currentUrl = $(location).attr('href');
		var baseUrl = currentUrl.substr(0, currentUrl.lastIndexOf('/') + 1);
		$http.get(baseUrl+"getTrainAnalysisJson?bstatus=ALL&type=D").then(function(response) {
		...
		$scope.getWeeklyConfirmed=function(){
			$http.get(baseUrl+"getTrainAnalysisJson?bstatus=ALL&type=W").then(function(response) {
				$('.doughnutDefault').hide();
				$('.doughnutDay').hide();
				$('.doughnutWeek').show();
				$('.doughnutMonth').hide();
	  ...
	  $scope.getMonthlyConfirmed=function(){
		   $http.get(baseUrl+"getTrainAnalysisJson?bstatus=ALL&type=M").then(function(response) {
			   $('.doughnutDefault').hide();
				$('.doughnutDay').hide();
				$('.doughnutWeek').hide();
				$('.doughnutMonth').show();
