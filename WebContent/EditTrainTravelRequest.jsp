		...
		<div class="col-sm-8 clearfix " data-placement="top">	
			...
			<section class="content">
				...
				<div class="row">
					...
					<form action="updateTrainTravelRequest" method="post"
					...
					<div class="form-group">
														<label for="carTravelRequest.TRNo" class=" control-label">
															...
															autocomplete="off" name=trainTravelRequest.TRNo
															class="form-control input-sm" id="TRNo" value='<s:property value="trainTravelRequest.TRNo"/>' required
													...
													<div class="form-group">
														...
														<input type="text" autocomplete="off"
															name="trainTravelRequest.firstName" value='<s:property value="trainTravelRequest.firstName"/>'
															class="form-control input-sm" required="required"
													...
													<div class="form-group">
														<label for="carTravelRequest.lastName">LastName </label> <input
															type="text" autocomplete="off" value='<s:property value="trainTravelRequest.lastName"/>'
											...
											<div class="form-group text-center">
												...
												<input type="hidden" name="trainTravelRequest.id" id="tripId" value="${trainTravelRequest.id}">
