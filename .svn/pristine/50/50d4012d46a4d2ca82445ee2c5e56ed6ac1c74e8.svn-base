	...
	<div>
		<div id="mypdf">
			<section class="content">
				<c:if test="${visaTravelRequest!=null}">
					<section class="content">
						<div class="row">
							<div class="col-sm-12">
								<h4>Visa Request Details</h4>
							</div>
						</div>
						<div class="row">
							<div class="mealexprow">
								<div class="row ">
									...
									<div class="p-info clearfix">
										...
										<div class="p-inp">
											<p>${visaTravelRequest.title}
												${visaTravelRequest.firstName} ${visaTravelRequest.lastName}</p>
										</div>
									</div>
					...
					<s:if
						test="visaTravelRequestQuotationlist!=null && visaTravelRequestQuotationlist.size()>0">
						<div class="row">
												...
												<tbody>
													...
													<c:forEach items="${visaTravelRequestQuotationlist}"
														...
														<tr>
															...
															<td>${visaTravelRequestQuotation.visaOrderRow.bookingCurrency} ${visaTravelRequestQuotation.visaOrderRow.totalAmount}</td>
															<td>
