	...
	<div class="content-wrapper">
		...
		<section class="content">
			...
			<div class="row">
				...
				<form action="showCarWeekOrderList" method="post" id="filterform">
								...
								<div class="panel-body">
									...
									<div class=" filter-text col-sm-12 clearfix">
										<div class="row">
											...
											<div class="col-sm-2">
												<div class="form-group clearfix">
													<label class="col-sm-12 control-label">Car Company
														Name</label>
													<div class="col-sm-12">
														<input type="text" autocomplete="on" class="form-control"
															id="companyName" placeholder="type car company Name"
									...
									<div class="date col-sm-12 clearfix">
										<div class="row">
											<div class="col-sm-4">
												<div class="form-group clearfix">
													<label class="col-sm-12 control-label">Booking Created Date</label>
													<div class="col-sm-6">
									...
									<thead>
										...
										<!--  <th>Base Price</th>
										 ...
										 <th>Service Tax</th>
											...
											<th>TollOrParking Charges</th>
											<th>DriverAllowanceNight</th>
											<th>DriverAllowanceDay</th>
										...
										<s:iterator value="commonReportPage.items" status="rowCount">
											<tr>
												<td><s:property
												  ...
												  <td><s:property value="createdAt" /> <s:date name="createdAt" format="dd-MM-yyyy"/></td>
												<td><s:property value="firstName" /> <s:property value="lastName" /></td>
												<td><s:property value="confirmationNumber" /></td>
													<td><s:property value="invoiceNo" /></td>
												<td><s:property value="bookingDate" /> <s:date name="bookingDate" format="dd-MM-yyyy"/></td>	
											...
											<%--  <td><s:property value="basePrice" /></td>
												...
												<td><s:property value="tollOrParkingCharges" /></td>
												<td><s:property value="driverAllowanceNight" /></td>
												<td><s:property value="driverAllowanceDay" /></td>
												
												<td><s:property value="extraHours" /></td>
												<td><s:property value="extraKM" /></td>
											<td><s:property value="serviceTax" /></td>
												...
												<td>
													<p data-placement="top" class="details">
														<a
															href="showPassengerDetailsOfCar?idForDetails=<s:property value="id"/>"
															class="btn btn-success btn-xs " data-toggle="modal">
															Details </a>
