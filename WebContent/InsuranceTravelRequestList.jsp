...
<div class="content-wrapper">
	...
	<section class="content-header">
			...
			<div class="col-sm-2 clearfix pull-left">
				<h4>Insurence Travel Request(s)</h4>
			</div>
		...
		<div class="row">
			<form action="superUserCompanyList" method="post" id="filterform">
				<div class="table-responsive dash-table">
					...
					<tbody>
						<s:iterator value="insuranceTravelRequestlist" status="rowCount">
							<tr>
								 ...
								 <td>
									...
									<div class="dropdown">
									    ...
									    <ul class="dropdown-menu " role="menu" aria-labelledby="menu1">
									      <li role="presentation"><a role="menuitem" tabindex="-1" href="editInsuranceTravelRequestQuotation?idtosend=<s:property value="id"/>">Edit Quatation</a></li>
									      <li role="presentation"><a role="menuitem" tabindex="-1" href="editInsuranceOrderRow?idtosend=<s:property value="id"/>">Insurance order</a></li>  
									      <li role="presentation"><a role="menuitem" tabindex="-1" href="editInsuranceTravelRequest?idtosend=<s:property value="id"/>">Edit Travel Request</a></li>    
									    </ul>
									    <a href="insuranceOrderQuotationView?id=<s:property value="id"/>"
