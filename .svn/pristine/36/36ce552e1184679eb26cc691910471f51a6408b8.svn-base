...
<div class="content-wrapper" ng-app="airDataApp">
	...
	<section class="content-header">
		<h1>
			Dashboard <small>Flight Panel</small> <i class="fa fa-plane"></i>
		</h1>
	...
	<section class="content overall">
					...
					<div class=" col-md-4" ng-controller="BookingConfirmCtrl">
						...
						<div class="small-box bg-green">
							<div class="inner">
								...
								<p>
									<s:text name="global.FlightConfirmedOrdercount"></s:text>
								</p>
							</div>
							<div class="icon">
							...
							<div class="small-week small-box-footer">
								 <label class="btn btn-transparent grey-salsa btn-sm "><span style="color: aqua;font-size: 15px" >{{confirmedCount.countD}}</span>&nbsp;&nbsp;&nbsp;
								  <a href="showIndividualFlightReportList?showReportType=BC&filterUptoDate=D"
									...
									<a href="showIndividualFlightReportList?showReportType=BC&filterUptoDate=W"
									...
									<a href="showIndividualFlightReportList?showReportType=BC&filterUptoDate=M"
									class="small-box-footer" >Month <i
										class="fa fa-arrow-circle-right"></i></a>
								</label>
							</div>
							<!-- <a href="showWeekOrderList?showType=flightconfirm"
					...
					<div class=" col-md-4" ng-controller="OrderPaymentSuccessCtrl">
						...
						<div class="small-box bg-blue">
							...
							<div class="small-week small-box-footer">
								 ...
								 <a
									href="showIndividualFlightReportList?showReportType=PS&filterUptoDate=D"
									class="small-box-footer" > Today <i
										class="fa fa-arrow-circle-right"></i></a>
								</label> <label class="btn btn-transparent grey-salsa  btn-sm "><span style="color: aqua;font-size: 15px" >{{successCount.countW}}</span>&nbsp;&nbsp;&nbsp;
									<a href="showIndividualFlightReportList?showReportType=PS&filterUptoDate=W"
									class="small-box-footer" >Week<i
										class="fa fa-arrow-circle-right"></i></a>
								</label> <label class="btn btn-transparent grey-salsa btn-sm "><span style="color: aqua;font-size: 15px" >{{successCount.countM}}</span>&nbsp;&nbsp;&nbsp;
									<a href="showIndividualFlightReportList?showReportType=PS&filterUptoDate=M"
									class="small-box-footer" >Month <i
										class="fa fa-arrow-circle-right"></i></a>
								</label>
							</div>
							<!-- <a href="showWeekOrderList?showType=flightpayment"
								class="small-box-footer">More info <i
								class="fa fa-arrow-circle-right"></i></a> -->
						</div>
					</div>
							...
							<div class="small-week small-box-footer">
								<label
									class="btn btn-transparent grey-salsa btn-sm "><span  style="color: aqua;font-size: 15px" >{{failedCount.countD}}</span>&nbsp;&nbsp;&nbsp;
									 <a href="showIndividualFlightReportList?showReportType=PF&filterUptoDate=D"
									class="small-box-footer" > Today <i
										class="fa fa-arrow-circle-right"></i></a>
								</label> <label class="btn btn-transparent grey-salsa  btn-sm "> <span style="color: aqua;font-size: 15px" >{{failedCount.countW}}</span>&nbsp;&nbsp;&nbsp;
									<a href="showIndividualFlightReportList?showReportType=PF&filterUptoDate=W"
									class="small-box-footer" >Week<i
										class="fa fa-arrow-circle-right"></i></a>
								</label> <label class="btn btn-transparent grey-salsa btn-sm "> <span  style="color: aqua;font-size: 15px" >{{failedCount.countM}}</span>&nbsp;&nbsp;&nbsp;
									<a href="showIndividualFlightReportList?showReportType=PF&filterUptoDate=M"
									class="small-box-footer" >Month <i
										class="fa fa-arrow-circle-right"></i></a>
								</label>
							</div>
							<!-- <a href="showWeekOrderList?showType=flightpaymentfailed"
								class="small-box-footer">More info <i
								class="fa fa-arrow-circle-right"></i></a> -->
						</div>
					</div>
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="panel panel-default" ng-controller="airDataCtrl">
					<div class="panel-heading clearfix">
						<div class="panel-title-box">
						...
						<ul class="panel-controls" style="margin-top: 2px;">
							...
							<li><a href="#" ng-click="refreshFlight()"
								class="panel-refresh"><span class="fa fa-refresh"></span></a></li>
							<%-- <li> <span class="fa fa-refresh" ng-click="refresh()"></span></li> --%>
							<li><a href="#" class="panel-fullscreen"><span
									class="fa fa-expand"></span></a></li>
						</ul>
					</div>
...
<script>
	...
	app.controller('airDataCtrl',function($scope, $http) {
						...
						$http.get(baseUrl + "getFlightBookingList").then(function(response) {
											$scope.commonTopFivePojoFlightList = response.data.commonTopFivePojoList;
										});
						$scope.refreshFlight = function() {$http.get(baseUrl + "getFlightBookingList")
	...
	app.controller('BookingConfirmCtrl',function($scope, $http) {
		...
		$http.get(baseUrl + "getFlightAnalysisJson?bstatus=HK").then(function(response) {
	...
	app.controller('OrderPaymentSuccessCtrl',function($scope, $http) {
		...
		$http.get(baseUrl + "getFlightAnalysisJson?pstatus=PS").then(function(response) {
	...
	app.controller('OrderPaymentFailedCtrl',function($scope, $http) {
		...
		$http.get(baseUrl + "getFlightAnalysisJson?pstatus=PF").then(function(response) {
	...
	app.controller('OrderChartCtrl', function($scope, $http) {
		...
		$http.get(baseUrl+"getFlightAnalysisJson?bstatus=ALL&type=D").then(function(response) {
		...
		$scope.getWeeklyConfirmed=function(){
			$http.get(baseUrl+"getFlightAnalysisJson?bstatus=ALL&type=W").then(function(response) {
				$('.doughnutDefault').hide();
				$('.doughnutDay').hide();
				$('.doughnutWeek').show();
				$('.doughnutMonth').hide();
	   ...
	   $scope.getMonthlyConfirmed=function(){
		   $http.get(baseUrl+"getFlightAnalysisJson?bstatus=ALL&type=M").then(function(response) {
			   $('.doughnutDefault').hide();
				$('.doughnutDay').hide();
				$('.doughnutWeek').hide();
				$('.doughnutMonth').show();
