						...
						<div class="panel-group" id="accordion">
							<div class="panel panel-default">
								<div class="panel-body">
									<form action="createVisaTravelRequest" method="post" 
								...
								<select class="form-control input-sm" name="visaOrderRow.companyEntityId" onchange="getEntity(this)" id="entity"  required="required">
								 ...
								 <span class="form-control-feedback glyphicon glyphicon-ok"></span>
										...
										<div class="col-sm-2">
											...
											<div class="detailswithRM">
												<div class="col-sm-2">
													<div class="form-group has-feedback">
														<label for="visaOrderCustomerList[0].title">Title</label> <select
															class="form-control input-sm" required="required"
															name="visaOrderCustomerList[0].title">
												...
												<div class="col-sm-2">
													<div class="form-group has-feedback">
														<label for="busTravelRequest.firstName"
															...
															type="text" autocomplete="off"
															name=visaOrderCustomerList[0].firstName
												...
												<div class="col-sm-2">
													<div class="form-group has-feedback">
														<label for="busTravelRequest[0].lastName"
															...
															type="text" autocomplete="off"
															name=visaOrderCustomerList[0].lastName
								...
								<div class="col-sm-2">
									<div class="form-group has-feedback">
										<label for="empCode" class=" control-label"> ${fieldName[0]}</label> <input type="text"
											autocomplete="off" name="visaOrderCustomerList[0].rmConfigTripDetailsModel.manualField1"
											class="form-control input-sm " 
											placeholder="Enter ${fieldName[0]}" required value="${configTripDetailsModel.manualField1}" >
											<span class="form-control-feedback glyphicon glyphicon-ok"></span>
									</div>
								</div>
							</c:if>
								...
								<div class="col-sm-2">
									<div class="form-group has-feedback">
										<label for="empCode" class=" control-label"> ${fieldName[1]}</label> <input type="text"
											autocomplete="off" name="visaOrderCustomerList[0].rmConfigTripDetailsModel.manualField2"
											class="form-control input-sm "
											placeholder="Enter ${fieldName[1]}" required value="${configTripDetailsModel.manualField2}" >
											<span class="form-control-feedback glyphicon glyphicon-ok"></span>
									</div>
								</div>
							</c:if>
								...
								<div class="col-sm-2">
									<div class="form-group has-feedback">
										<label for="empCode" class=" control-label"> ${fieldName[2]}</label> <input type="text"
											autocomplete="off" name="visaOrderCustomerList[0].rmConfigTripDetailsModel.manualField3"
											class="form-control input-sm "
											placeholder="Enter ${fieldName[2]}" required value="${configTripDetailsModel.manualField3}" >
											<span class="form-control-feedback glyphicon glyphicon-ok"></span>
									</div>
								</div>
							</c:if>
								...
								<div class="col-sm-2">
									<div class="form-group has-feedback">
										<label for="empCode" class=" control-label"> ${fieldName[3]}</label> <input type="text"
											autocomplete="off" name="visaOrderCustomerList[0].rmConfigTripDetailsModel.manualField4"
											class="form-control input-sm "
											placeholder="Enter ${fieldName[3]}" required value="${configTripDetailsModel.manualField4}" >
											<span class="form-control-feedback glyphicon glyphicon-ok"></span>
									</div>
								</div>
							</c:if>
								...
								<div class="col-sm-2">
									<div class="form-group has-feedback">
										<label for="empCode" class=" control-label"> ${fieldName[4]}</label> <input type="text"
											autocomplete="off" name="visaOrderCustomerList[0].rmConfigTripDetailsModel.manualField5"
											class="form-control input-sm " 
											placeholder="Enter ${fieldName[4]}" required value="${configTripDetailsModel.manualField5}" >
											<span class="form-control-feedback glyphicon glyphicon-ok"></span>
									</div>
								</div>
							</c:if>
											...
											<div class="col-sm-2">
												<div class="form-group has-feedback">
													<label for="visaTravelRequest.trNo" class=" control-label">
														...
														autocomplete="off" name="visaOrderCustomerList[0].rmConfigTripDetailsModel.trNumber"
														class="form-control input-sm " id="confirmationNumber"
														value="" required
											...
											<div class="col-sm-2" >
													<div class="form-group has-feedback">
														<label for="empCode" class=" control-label"> Emp Code</label> <input
															type="text" autocomplete="off"
															name="visaOrderCustomerList[0].rmConfigTripDetailsModel.empCode"
											...
											<div class="col-sm-2"  >
													<div class="form-group has-feedback">
														<label for="empCode" class=" control-label"> Department</label> <input
															type="text" autocomplete="off"
															name="visaOrderCustomerList[0].rmConfigTripDetailsModel.department"
											...
											<div class="col-sm-2" >
													<div class="form-group has-feedback">
														<label for="empCode" class=" control-label">Cost Center</label> <input
															type="text" autocomplete="off"
															name="visaOrderCustomerList[0].rmConfigTripDetailsModel.costCenter"
											...
											<div class="col-sm-2" >
													<div class="form-group has-feedback" >
														<label for="empCode" class=" control-label">Approver Name</label> <input
															type="text" autocomplete="off"
															name="visaOrderCustomerList[0].rmConfigTripDetailsModel.approverName"
											...
											<div class="col-sm-2"  >
													<div class="form-group has-feedback">
														<label for="empCode" class=" control-label">location</label> <input
															type="text" autocomplete="off"
															name="visaOrderCustomerList[0].rmConfigTripDetailsModel.location"
											...
											<div class="col-sm-2" >
													<div class="form-group has-feedback">
														<label for="empCode" class=" control-label">Bussiness Unit</label> <input
															type="text" autocomplete="off"
															name="visaOrderCustomerList[0].rmConfigTripDetailsModel.bussinessUnit"
											...
											<div class="col-sm-2"  >
													<div class="form-group has-feedback">
														<label for="projectCode" class=" control-label"> Project Code</label> <input
															type="text" autocomplete="off"
															name="visaOrderCustomerList[0].rmConfigTripDetailsModel.projectCode"
											...
											<div class="col-sm-2"  >
													<div class="form-group has-feedback">
														<label for="reasonForTravel" class=" control-label">Reason For Travel</label> <input
															type="text" autocomplete="off"
															name="visaOrderCustomerList[0].rmConfigTripDetailsModel.reasonForTravel"
											...
											<div class="col-sm-2"  >
													<div class="form-group has-feedback" >
														<label for="billNonBill" class=" control-label">Billing/Non Billing</label> <input
															type="text" autocomplete="off"
															name="visaOrderCustomerList[0].rmConfigTripDetailsModel.billNonBill"
						           ...
						           <div class="col-sm-12  pricebreakup"> 
														...
														<div class="col-sm-2"> 
																<div class="form-group has-feedback">
																	<label for="busOrderRow.supplierPrice"
																		...
																		type="text" autocomplete="off"
																		name=visaOrderCustomerList[0].supplierAmount
															...
															<div class="col-sm-2">
																<div class="form-group has-feedback"><%-- ${flightQuotation.totalAmount} --%>
																	<label for="hotelName" class=" control-label">Base
																		...
																		id="baseFare"
																		name="visaOrderCustomerList[0].baseAmount"
															...
															<div class="col-sm-2">
																<div class="form-group has-feedback">
																	<label for="hotelName" class=" control-label notone">Tax
																	 ...
																	 id="taxFare" value="0"
																		name="visaOrderCustomerList[0].tax"
															...
															<div class="col-sm-2">
																<div class="form-group has-feedback">
																	<label for="hotelName" class=" control-label notone1">Markup
																		...
																		name="visaOrderCustomerList[0].markUp"
										...
										<div class="companysetup clearfix"> 
											...
											<div class="col-sm-2">
											 ...
											 <div class="col-sm-2">
												<div class="form-group">
													<label for="visaOrderRow.supplierPrice"
														...
														required placeholder="Enter Supplier Price" readonly>
												</div>
												</div>
												<div class="col-sm-2">
												...
												<div class="form-group">
													<label for="visaOrderRow.basePrice" class=" control-label">
														...
														required placeholder="Enter Base Price" readonly>
												</div>
												</div>
											 <div class="col-sm-2">
												<div class="form-group has-feedback">
													<label for="visaOrderRow.vfsCharges" class=" control-label">
														...
														onchange="numbersonly(this)" class="form-control input-sm cusValidationforprice"
												...
												<div class="form-group has-feedback">
													<label for="visaOrderRow.courierCharges"
														...
														class="form-control input-sm cusValidationforprice" id="courierCharges"
											 ...
											 <div class="col-sm-2">
												<div class="form-group">
													<label for="visaOrderRow.markUp" class=" control-label"> Total Mark
														...
														required placeholder="Enter Markup" readonly="readonly">
												</div>
												</div>
	...
	$(document).ready(function () {
	    ...
	    $("#createVisaExpense").validate({
	     ...
	     $('#visaexpensesubmitnew').click(function() {
	        ...
	        console.log($("#createVisaExpense").valid())
...
/* 	$('#createVisaExpense').bootstrapValidator({
	    trigger: 'blur',
	    fields: {
	    	 myClass: {
	...
	function add(currentObj) {  
		...
		$('#quoteamount').val(totalManagementFee);
		 ...
		 for (var i = noOfRooms; i <= noOfRooms; i++) {
			  ...
			  $rooms.find("h4.panel-title a[href='#collapseinside']").attr("href", "#collapseinside" + (i));
				...
				$rooms.find(".inner-compreg .form-group input[name^=visaOrderCustomerList]").each(function() {
				...
				$rooms.find(".inner-compreg .form-group select[name^=visaOrderCustomerList]").each(function() {
					var name = $(this).attr('name');
					var indexOfThirdBracket = name.indexOf('[') + 1;
					name = name.substring(0,
							indexOfThirdBracket)
				...
				$rooms.find(".price-details .form-group input[name^=visaOrderCustomerList]").each(function() {
	 ...
	 $('#courierCharges,#vfsCharges').keyup(function(){
		 addtax();
		});
