	...
	<div class="content-wrapper">
		...
		<section class="content">
			...
			<div class="row">
				...
				<form action="" method="post" id="filterform"><!-- filterform -->
											...
											<div class="col-sm-2">
											 ...
											 <div class="col-sm-2">
												<div class="form-group clearfix">
													...
													<div class="col-sm-12">
													<select name="companyFilterPage.companyFilter.companyRoleType" id="companyRoleType"
															value="<s:property value="companyFilterPage.companyFilter.companyRoleType"/>">
														<s:if test="companyFilterPage.companyFilter.companyRoleType!=null">
															<option value="<s:property value="companyFilterPage.companyFilter.companyRoleType"/>" selected="selected"><s:property value="companyFilterPage.companyFilter.companyRoleType"/></option>
														</s:if>
...
<%-- 	<script src="js/jquery-ui.js"></script> --%>
	...
	$('#xlsdownload').click(function() {
				$("#filterform").attr("action","CustomerOrderListReportExcelDownload");
				$("#filterform").submit();
	});
	$('#filterSubmit').click(function () {
		$("#filterform").attr("action","CustomerOrderList");
		$("#filterform").submit();
	});
	</script>
