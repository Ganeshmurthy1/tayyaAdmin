...
public class FlightWeeklyAndMonthlyDao {

	public static final Logger logger = Logger.getLogger(FlightWeeklyAndMonthlyDao.class);
	
	public Map<String, Integer> getFlightWeeklyOrMonthlyReport(User userSessionObj, Company companySessionObj, List<String> userIdList,String reportType) {
		List<FlightOrderRow> flightOrderRows=new ArrayList<>();
		...
		try {
			...
			if (userSessionObj != null && companySessionObj != null) {
				...
				flightOrderRows = criteria.list();
				for (FlightOrderRow flightOrderRow : flightOrderRows) {
					String[] datenTime =flightOrderRow.getCreatedAt().toString().split(" ");
	...
	public Long getFlightWeeklyOrMonthlyCancellationCount(User userSessionObj, Company companySessionObj, List<String> userIdList,String reportType) {
		List<FlightOrderRow> flightOrderRows=new ArrayList<>();
		Map<String, Integer> weekMap=new HashMap<>();
		SessionFactory sessionfactory;
		Session session = null;
