...
<body>
	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			<h1>
				Add Galileo Configuration <%-- <small>Control panel</small> --%>
			</h1>
			<!-- <ol class="breadcrumb">
	 ...
	 <s:if test="hasActionErrors()">
			...
			<div class="row" id="dash-us-register">
				...
				<form action="addGalileoConfigData" method="post"
					class="form-horizontal">
					<div class="form-group">
						<label for="Username" class="col-sm-2 control-label">Url</label>
						<div class="col-sm-8">
							<input type="text" class="form-control input-sm" id="username"
								name="url" placeholder="url" autocomplete="off" required>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control input-sm" id="first-name"
								name="target_branch" placeholder="Target Branch"
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control input-sm" id="first-name"
								name="user_name" placeholder="User ID " autocomplete="off"
								required>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control input-sm" name="pcc"
								id="telphone" placeholder="Pcc" autocomplete="off" required>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control input-sm"
								name="environment" id="telphone" placeholder="Environment"
								autocomplete="off" required>
						</div>
					</div>
