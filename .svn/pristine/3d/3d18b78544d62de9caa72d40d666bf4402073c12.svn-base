	...
	<section class="content">
		...
		<input type="hidden"
				...
				<input type="hidden"
					...
					id="user_id">
			<form action="FlightBookAndSearchView" method="post" id="filterform">
								...
								<tr>
									...
									<td>
										<p data-placement="top">
											<a href="FlightLookList?configIds=<s:property value="configId"/>&searchType=flight&companyId=<s:property value="companyId"/>"
												class="btn btn-success btn-xs" > Look
											</a> <a href="FlightBookList?configIds=<s:property value="configId"/>&searchType=flight&companyId=<s:property value="companyId"/>"
