	...
	<div class="content-wrapper">
		...
		<section class="content">
			...
			<form action="updateTboConfig" method="post"
				class="form-horizontal" name="myForm" id="updateTboConfigForm">
				<input type="hidden"   
							name="id"  
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<select  class="form-control input-sm"
							...
							<s:if test="apiProviderTboConfig.isActive()">
			...
			<div class="form-group">
					...
					<div class="col-sm-8">
						 <input type="text" class="form-control input-sm" id="apiCurrency" required
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<select  class="form-control input-sm"
							...
							<s:if test="apiProviderTboConfig.environment == 'test'">
								<option value="test" selected="selected">Test</option>
							<option value="live">Live</option>
							</s:if>
							<s:elseif test="apiProviderTboConfig.environment == 'live'">
					...
					<div class="col-sm-8">
						 <input type="text" class="form-control input-sm" id="clientId"
							name="clientId" placeholder="Client Id" autocomplete="off" required
					...
					<div class="col-sm-8">
						 <input type="number" class="form-control input-sm" id="providerId"
							name="providerId" placeholder="property Id" autocomplete="off" required
					...
					<div class="col-sm-8">
						 <input type="text" class="form-control input-sm" id="propertyId" required
				...
				<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control input-sm" id="generalUrlAgencyBalance"
								name="generalUrlAgencyBalance" placeholder="Agenecy Balance Url" autocomplete="off" value="${apiProviderTboConfig.generalUrlAgencyBalance}"
								  required>
						</div>
					</div>	
	...
	$(document).ready(function(){
		    ...
		    $("#updateTboConfigForm").validate({
		     ...
		     $('#buttonSubmit').click(function() {
		       if($("#updateTboConfigForm").valid())
		        	document.getElementById("updateTboConfigForm").submit();
