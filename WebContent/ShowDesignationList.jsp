			...
			<div class="form-group" id="user_form-group" >
						...
						<div class="row">
							<div class="col-sm-4">
								<a class="btn btn-primary" role="button" data-toggle="collapse"
									href="" aria-expanded="false" aria-controls="filters">
							...
							<div class="col-sm-3 clearfix pull-right">
								<div class="add-new">
									<a class="btn btn-primary but btn-clean" style="border: 2px solid #a1a1a1;border-radius: 15px" role="button"
										href="adduserdesignation"> <i class="fa fa-plus "> Add New </i>
									</a>
								</div>
							</div>
						</div>
				...
				<div class="table-responsive dash-table">
					<table  id="mytable" class="table table-striped"
						...
						<tbody>
							<s:iterator value="employeeDesignationsList" status="rowCount">
								<tr>
									<%--  <td><s:property
											value="%{((commonConfigPage.currentPageIndex - 1)*commonConfigPage.maxItems)+#rowCount.count}" /></td>	 --%>
									<td><s:property value="desgId" /></td>
									<td><s:property value="desgCode"/></td>
									<td><s:property value="desgName" /></td>
									<td><s:property value="employeeBandModel.bandId" /></td>
									<td><s:property value="companyid" /></td>
									 <td>
										<p data-placement="top" title="edit">

											<a
												href="EditDesignation?employeeDesignations.desgId=<s:property value="desgId"/>" style="border: 1px solid #a1a1a1;border-radius: 3px;" role="button"
...
<script type="text/javascript">
		function userDelete(id) {
			...
			var finalUrl = newUrl + "DeleteEmployeeInfoById";
             console.log(id);
			$("#yes" + id)
					.click(
							function() {
								...
								$
										.ajax({
											...
											success : function(data, status) {
												alert(data.deleteRes);
												console.log("daa",data.deleteRes);
												if (data.deleteRes == "success") {
													alert("inside");
