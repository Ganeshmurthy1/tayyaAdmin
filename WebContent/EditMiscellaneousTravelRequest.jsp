			...
			<section class="content">
				...
				<div class="row">
					...
					<div class="col-sm-12">
									...
									<form action="updateMiscellaneousTravelRequest" method="post"
					...
					<div class="inner-compreg clearfix">  
												<div class="col-sm-2">
													<div class="form-group">
														<label for="miscellaneousTravelRequest.travelRequestNumber" class=" control-label">
															...
															autocomplete="off" name=miscellaneousTravelRequest.travelRequestNumber
															class="form-control input-sm" id="TRNo" value='<s:property value="miscellaneousTravelRequest.travelRequestNumber"/>' required
												...
												<div class="col-sm-2">
													...
													<div class="form-group">
														<label for="miscellaneousTravelRequest.title" class=" control-label">Title</label>
														 <select class="form-control input-sm" required="required" 
															name="miscellaneousTravelRequest.title">
												...
												<div class="col-sm-2">
													<div class="form-group">
														<label for="miscellaneousTravelRequest.firstName" class=" control-label">FirstName</label>
														<input type="text" autocomplete="off"
															name="miscellaneousTravelRequest.firstName" value='<s:property value="miscellaneousTravelRequest.firstName"/>'
												...
												<div class="col-sm-2">
													<div class="form-group">
														<label for="miscellaneousTravelRequest.lastName" class=" control-label">LastName </label> <input
															type="text" autocomplete="off" value='<s:property value="miscellaneousTravelRequest.lastName"/>'
															name="miscellaneousTravelRequest.lastName"
															class="form-control input-sm" required="required"
												...
												<div class="col-sm-2">
													<div class="form-group">
														<label for="miscellaneousTravelRequest.details1" class=" control-label">Details 1 </label> <input
															type="text" autocomplete="off" value='<s:property value="miscellaneousTravelRequest.details1"/>'
															name="miscellaneousTravelRequest.details1"
															class="form-control input-sm" required="required"
															placeholder="Last Name">
												...
												<div class="col-sm-2">
													<div class="form-group">
														<label for="miscellaneousTravelRequest.details2" class=" control-label">Details 2</label>
														<input type="text" autocomplete="off"
															name="miscellaneousTravelRequest.details2" value='<s:property value="miscellaneousTravelRequest.details2"/>'
															class="form-control input-sm" required="required"
															placeholder="First Name">
												...
												<div class="col-sm-2">
													<div class="form-group">
														<label for="miscellaneousTravelRequest.entity" class=" control-label">Entity </label> <input
															type="text" autocomplete="off" value='<s:property value="miscellaneousTravelRequest.entity"/>'
															name="miscellaneousTravelRequest.entity"
															class="form-control input-sm" required="required"
															placeholder="Last Name">
												...
												<div class="col-sm-2">
													<div class="form-group">
														<label for="miscellaneousTravelRequest.confirmationNumber" class=" control-label">Confirmation number </label> <input
															type="text" autocomplete="off" value='<s:property value="miscellaneousTravelRequest.confirmationNumber"/>'
															name="miscellaneousTravelRequest.confirmationNumber"
															class="form-control input-sm" required="required"
															placeholder="Last Name">
												...
												<div class="col-sm-2">
													<div class="form-group">
														<label for="miscellaneousTravelRequest.totalAmount" class=" control-label">Total Amount </label> <input
															type="text" autocomplete="off" value='<s:property value="miscellaneousTravelRequest.totalAmount"/>'
															name="miscellaneousTravelRequest.totalAmount"
															class="form-control input-sm" required="required"
															placeholder="Last Name">
											...
											<div class="form-group text-center">
												...
												<input type="hidden" name="miscellaneousTravelRequest.id" id="tripId" value="${miscellaneousTravelRequest.id}">
													<!-- <button type="submit" name="" value=""
														id=""
														class="btn btn-primary btn-lg">Miscellaneous Travel Request
														update</button> -->
														<button type="button" name="" value=""
														id="updateMiscelleniousSubmit"
														class="btn btn-primary btn-lg">Miscellaneous Travel Request
														update</button>
												</div>
											</div>
...
$(document).ready(function(){
	   ...
	   $('#updateMiscelleniousSubmit').click(function(){
