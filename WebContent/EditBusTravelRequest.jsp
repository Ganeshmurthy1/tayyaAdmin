						...
						<div class="panel-group" >
							<div class="panel panel-default">
								...
								<!-- <div id="collapseFour" class="panel-collapse collapse"> -->
										...
										<form action="updateBusTravelRequest" method="post"
						...
						<div class="col-sm-2">
													<div class="form-group">
														<label for="carTravelRequest.TRNo" class=" control-label">
															...
															class="form-control input-sm" id="TRNo" value='<s:property value="busTravelRequest.TRNo"/>' required
												...
												<div class="col-sm-2">
													<div class="form-group">
														...
														<input type="text" autocomplete="off"
															name="busTravelRequest.firstName" value='<s:property value="busTravelRequest.firstName"/>'
															class="form-control input-sm" required="required"
												...
												<div class="col-sm-2">
													<div class="form-group">
														<label for="carTravelRequest.lastName">LastName </label> <input
															type="text" autocomplete="off" value='<s:property value="busTravelRequest.lastName"/>'
											...
											<div class="form-group text-center">
												...
												<input type="hidden" name="busTravelRequest.id" id="tripId" value="${busTravelRequest.id}">
													<button type="button" name="busTravelRequest" value=""
														id="busTravelRequestsubmitnew"
														class="btn btn-primary btn-lg">bus Travel Request
														update</button>
												</div>
											</div> 
										</form> 
