				 ...
				 <div class="flight-admin-details">
                     <h3><span>Visa Details:-</span></h3>
								...
								<table class="table table-striped table-bordered"
									...
									<tbody>
 										<tr> 
											 <td><s:property value="visaOrderRow.confirmationNumber"/></td>
												<td><s:property value="visaOrderRow.invoiceNo" /></td>
												<td><s:property value="visaOrderRow.bookingCurrency" /></td>
 												<td><s:property value="visaOrderRow.orderId"/></td>
 												<td><s:property value="visaOrderRow.statusAction" /></td>
												<td><s:property value="visaOrderRow.paidBy" /></td>
												<td><s:property value="visaOrderRow.remarks" /></td>
								...
								<table class="table table-striped table-bordered"
									...
									<tbody>
											  <s:iterator value="visaOrderRow.orderCustomer">
											<tr>
